...
1.  [Copiar datos en el servidor de destino](Move-Windows-SBS-2008-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md#BKMK_CopyData)  
...
3.  [Mover el rol servidor DHCP del servidor de origen al enrutador](Move-Windows-SBS-2008-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md#BKMK_MoveDHCP)  
...
5.  [Quitar objetos de directiva de grupo de Active Directory heredados (opcional)](Move-Windows-SBS-2008-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md#BKMK_RemoveLegacyADGPO)  
  
6.  [Asignar los equipos permitidos a cuentas de usuario](Move-Windows-SBS-2008-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md#BKMK_MapPermittedComputers)  
...
##  <a name="BKMK_RemoveLegacyADGPO"></a> Quitar objetos de directiva de grupo de Active Directory heredados (opcional)  

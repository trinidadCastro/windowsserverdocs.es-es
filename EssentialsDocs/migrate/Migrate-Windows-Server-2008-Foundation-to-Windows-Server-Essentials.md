...
En esta guía se describe cómo migrar un dominio existente de Windows Server 2008 Foundation a Windows Server® 2012 Essentials en hardware nuevo y, después, migrar la configuración y los datos. En esta guía también se describe cómo quitar el servidor existente de la red de Windows Server Essentials después de finalizar la migración.  

...
-   [Dejar de compartir archivos multimedia digitales](Manage-Digital-Media-in-Windows-Server-Essentials.md#BKMK_9)  
  
-   [Permitir que los dispositivos de medios que utilizan el protocolo de bloque de mensajes del servidor (SMB) para tener acceso a archivos compartidos en el servidor](Manage-Digital-Media-in-Windows-Server-Essentials.md#BKMK_10)  
  
-   [Procesadores comunes y los perfiles de vídeo compatibles](Manage-Digital-Media-in-Windows-Server-Essentials.md#BKMK_CommonProcessors)  
  
-   [Problemas conocidos relacionados con los tipos de archivo multimedia](Manage-Digital-Media-in-Windows-Server-Essentials.md#BKMK_KnownIssues)  
...
### <a name="why-would-i-want-to-stream-my-digital-media"></a>¿Por qué debería transmitir mis medios digitales?  
 Mucha gente almacena música, vídeo e imágenes en las carpetas compartidas en Windows Server Essentials. A veces, puede desear hacer lo siguiente:  
...
###  <a name="BKMK_1.5"></a> Uso compartido de multimedia protegido contra copia  
...
##  <a name="BKMK_4"></a> Activar o desactivar la transmisión por secuencias  
 ...
 Para obtener una lista actualizada de los dispositivos de medios digitales compatibles con Windows Server Essentials, consulte el [centro de compatibilidad de Windows](https://www.microsoft.com/windows/compatibility/CompatCenter/Home).  
  
### <a name="enabling-media-sharing"></a>Habilitar el uso compartido de multimedia  
 Para compartir los medios que se almacenan en Windows Server Essentials, deberá activar el streaming multimedia. La transmisión por secuencias de multimedia está desactivada de manera predeterminada.  
...
-   Si activa el uso compartido de biblioteca multimedia para una carpeta compartida, cualquier reproductor multimedia digital o DMR admitido que puede tener acceso a la red de Windows Server Essentials también puede acceder a archivos multimedia digitales de esa carpeta compartida. Por ejemplo, si tiene una red inalámbrica y no está protegida, cualquier usuario dentro del alcance de su red inalámbrica podrá tener acceso a sus medios digitales de esa carpeta. Antes de activar el uso compartido de la biblioteca multimedia, asegúrese de que su red inalámbrica esté protegida. Para obtener más información, vea la documentación del punto de acceso inalámbrico.  
  
##  <a name="BKMK_8"></a> Cambiar el nombre de la biblioteca multimedia  
 El nombre predeterminado de la biblioteca multimedia es **Servidor de medios digitales**. Se crea al activar el streaming multimedia en Windows Server Essentials. Para obtener más información sobre cómo activar la transmisión por secuencias de multimedia, consulte [para activar o desactivar la transmisión por secuencias](Manage-Digital-Media-in-Windows-Server-Essentials.md#BKMK_2.5). Puede modificar el nombre de la biblioteca multimedia en cualquier momento con el panel del servidor.  
...
##  <a name="BKMK_9"></a> Dejar de compartir archivos multimedia digitales  
...
##  <a name="BKMK_10"></a> Permitir que los dispositivos de medios que utilizan el protocolo de bloque de mensajes del servidor (SMB) para tener acceso a archivos compartidos en el servidor  
...
##  <a name="BKMK_CommonProcessors"></a> Procesadores comunes y los perfiles de vídeo compatibles  
 Para transmitir medios desde el servidor de Windows Server Essentials, puede usar un equipo que ejecuta el sistema operativo Windows 7 o Windows 8 u otros dispositivos de red (como reproductores multimedia digitales) o Media Center Extender (como Xbox 360). Cuando esté fuera de la red puede usar el reproductor multimedia de Acceso Web remoto para reproducir archivos almacenados en el servidor.  
...
##  <a name="BKMK_KnownIssues"></a> Problemas conocidos relacionados con los tipos de archivo multimedia  

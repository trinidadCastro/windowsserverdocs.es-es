...
-   [Configurar copia de seguridad para un equipo cliente](Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_3)  
  
-   [Cambiar la hora de copia de seguridad está programada para ejecutarse](Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_4)  
...
-   [Restablecer configuración predeterminada de copia de seguridad](Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_6)  
...
-   [Deshabilitar copia de seguridad para un equipo](Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_9)  
  
-   [Ejecute la tarea de limpieza de copia de seguridad](Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_10)  
  
-   [Ver las alertas en la barra de tareas en un equipo cliente](Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_11)  
...
-   [Sugerencias para ayudar a evitar la pérdida de datos debido a daños en la base de datos de copia de seguridad de cliente](Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_16)  
...
##  <a name="BKMK_2"></a> Comprender la configuración de copia de seguridad del equipo  
...
|--------------------|-------------|-----------------|  
|Hora de inicio|6:00 p. m.|Especifica la hora a la que se inicia la copia de seguridad diaria. Se recomienda establecer este valor en una hora en la que los usuarios no usen sus equipos.|  
...
##  <a name="BKMK_3"></a> Configurar copia de seguridad para un equipo cliente  
...
> [!IMPORTANT]
>   Windows Server Essentials no es compatible con copia de seguridad y restauración de discos dinámicos en los equipos cliente.  
...
##  <a name="BKMK_4"></a> Cambiar la hora de copia de seguridad está programada para ejecutarse  
...
##  <a name="BKMK_6"></a> Restablecer configuración predeterminada de copia de seguridad  
...
-   Hora de inicio de copia de seguridad: 6:00 p. m.  
 ...
 **Recuperación de equipos:** puede crear una unidad flash USB de arranque que se usará para restaurar un equipo desde una copia de seguridad existente. Debe usar una unidad flash USB de 1 GB o más. Después de crear la unidad flash USB de arranque, insértela en el equipo que quiera restaurar y después inícielo desde dicha unidad flash USB para iniciar el proceso de restauración completa del sistema.  
  
##  <a name="BKMK_8"></a> Reparar la base de datos de copia de seguridad  
...
7.  Según el tamaño de la base de datos de copias de seguridad, la reparación puede tardar varias horas. Haga clic en **Cerrar** y después, en **Aceptar** para cerrar la página **Personalizar la configuración de copia de seguridad de equipos y del Historial de archivos**.  
    ...
    > [!NOTE]
    >  En Windows Server Essentials, haga clic en **configuración de copia de seguridad de equipos cliente y herramientas**.  
...
##  <a name="BKMK_9"></a> Deshabilitar copia de seguridad para un equipo  
...
##  <a name="BKMK_11"></a> Ver las alertas en la barra de tareas en un equipo cliente  
...
-    Windows Server Essentials: se ha agregado un nuevo volumen al equipo. La persona que administra la red debe ejecutar el asistente para personalizar las copias de seguridad de modo que incluya o excluya el volumen para futuras copias de seguridad.  
...
3.  En el cuadro de diálogo **Propiedades de la copia de seguridad** , el estado de la copia de seguridad se muestra en la sección **Estado de la copia de seguridad** .  
    ...
    -   **No se puede conectar**: la copia de seguridad no puede conectar con el servicio de proveedores de copias de seguridad de equipos cliente de Windows Server.  
        ...
        > [!NOTE]
        >  En Windows Server Essentials, este servicio ha sido cambiado el nombre del servicio de administración de equipos de cliente de Windows Server Essentials.  
  
    -   **Haciendo copia de seguridad**: muestra el porcentaje de copia de seguridad completado.  
...
##  <a name="BKMK_13"></a> Detener una copia de seguridad en curso desde Launchpad  
...
##  <a name="BKMK_14"></a> Iniciar una copia de seguridad desde Launchpad  
...
##  <a name="BKMK_16"></a> Sugerencias para ayudar a evitar la pérdida de datos debido a daños en la base de datos de copia de seguridad de cliente  
...
-   Habilite un método adicional de copia de seguridad de la base de datos de copias de seguridad del cliente. Por ejemplo, según la versión de Windows Server Essentials que esté usando, use Microsoft Azure Backup, copia de seguridad en línea o copia de seguridad de servidor para realizar copias de seguridad de la base de datos.  
...
-   Antes de limpiar o restaurar la base de datos de copias de seguridad del cliente, asegúrese de detener todas las copias de seguridad del cliente que estén actualmente en curso.  
     ...
     Si está ejecutando Windows Server Essentials, debe detener también el servicio de copia de seguridad de los equipos cliente de Windows Server y el servicio proveedor de copia de seguridad de equipos de cliente de Windows Server.  
  
     Si está ejecutando Windows Server Essentials, debe detener también el servicio de copia de seguridad de equipos de Windows Server.  
...
##  <a name="BKMK_FileHistory"></a> Historial de archivos de descripción  
 ...
 En Windows Server Essentials, puede personalizar la configuración del historial de archivos desde el **historial de archivos** página de **configuración de copia de seguridad de equipos cliente y herramientas**.  
  
 En Windows Server Essentials, puede personalizar la configuración del historial de archivos yendo a la **usuarios** ficha y, a continuación, seleccionando la **cambiar la configuración del historial de archivos** tarea.  

...
>Se aplica a: Windows Server 2016 Essentials, Windows Server 2012 R2 Essentials, Windows Server 2012 Essentials
 ...
 Como administrador del servidor, puede administrar el acceso a las carpetas de servidor (conocido como carpetas compartidas al acceder desde el Launchpad, acceso Web remoto, la aplicación My Server para Windows Phone o la aplicación My Server para Windows 8) en el servidor mediante el uso de las tareas en el  **Las carpetas del servidor** ficha del panel, lo que permite a los usuarios tengan distintos niveles de acceso a una variedad de archivos.  
...
|Ver las propiedades de la carpeta|Muestra las propiedades de la carpeta seleccionada y permite:<br /><br /> -Cambiar el nombre de las carpetas creadas por el usuario.<br /><br /> -Cambiar la descripción de una carpeta seleccionada.<br /><br /> -Ver el tamaño de la carpeta.<br /><br /> -Abra la carpeta seleccionada en el Explorador de archivos.<br /><br /> -Especifique los permisos de acceso de la cuenta de usuario para la carpeta seleccionada.<br /><br /> -Ocultar una carpeta seleccionada de las aplicaciones de acceso Web remoto y servicio Web.<br /><br /> -Especificar la cuota de carpeta.|  
...
##  <a name="BKMK_1"></a> Administrar el acceso a las carpetas del servidor  
...
-   [Ver o modificar las propiedades de carpeta de servidor](Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_10)  
...
4.  En el **< Carpetadelservidor\> tareas** panel, haga clic en **ver propiedades de la carpeta**.  
  
5.  En **< nombreDeCarpeta\> propiedades**, haga clic en **compartir**, seleccione **ocultar esta carpeta de aplicaciones de acceso Web remoto y servicio Web**y, a continuación, haga clic en **Aplicar**.  
  
###  <a name="BKMK_Perms"></a> Establecer permisos para las carpetas del servidor  
...
###  <a name="BKMK_10"></a> Ver o modificar las propiedades de carpeta de servidor  
...
> [!NOTE]
>  En Windows Server Essentials y Windows Server 2012 R2 con el rol experiencia con Windows Server Essentials instalado, también puede modificar la cuota de carpeta.  
...
5.  En **< nombreDeCarpeta\> propiedades**, en el **General** pestaña, ver o modificar el nombre y la descripción de la carpeta del servidor.  
  
    > [!NOTE]
    >  En Windows Server Essentials y Windows Server 2012 R2 con el rol experiencia con Windows Server Essentials instalado, también puede modificar la cuota de carpeta que emite un mensaje de advertencia cuando una carpeta del servidor alcanza el tamaño especificado.  
...
-   Un servidor miembro que ejecutan Windows Server Essentials o Windows Server 2012 R2 con el rol experiencia con Windows Server Essentials instalado  
...
##  <a name="BKMK_9"></a> Agregar una carpeta del servidor que falta  
 ¿Cuando el servidor detecta que una carpeta de servidor predefinidas? Empresa, los usuarios, copias de seguridad del equipo cliente, copia de seguridad de historial de archivos o redirección de carpetas? ya no se comparte (por alguna razón u otra), se genera una alerta para guiar al usuario para resolver este problema. Se recomienda intentar restaurar la carpeta de la copia de seguridad del servidor. Sin embargo, si no ha creado la copia de seguridad en el servidor, seleccione la carpeta que falta y haga clic en **Vuelva a crear la carpeta que falta** para configurar de nuevo la ubicación de la carpeta del servidor.  
  
> [!NOTE]
>  ¿Solo las carpetas predefinidas? Empresa, los usuarios, copias de seguridad del equipo cliente, copia de seguridad de historial de archivos o redirección de carpetas? puede volver a crear. No pueden crearse de nuevo las carpetas del servidor multimedia ni las carpetas del servidor creadas por el usuario.  
  
 Después de restaurar o volver a crear la carpeta que falta, esta ya no debe aparecer como **Falta**.  
  
 Para obtener información sobre cómo restaurar archivos de copias de seguridad de servidor, consulte la sección aprender más acerca de cómo restaurar archivos y carpetas en el tema [administrar copias de seguridad y restauración](Manage-Backup-and-Restore-in-Windows-Server-Essentials.md).  
  
##  <a name="BKMK_11"></a> Comprender las carpetas compartidas  
 Desde un dispositivo conectado al servidor, puede acceder a las carpetas compartidas en Windows Server Essentials de varias maneras. Para obtener más información, vea el tema [Use Shared Folders](../use/Use-Shared-Folders-in-Windows-Server-Essentials.md).  
...
-   [Administrar almacenamiento de servidor](Manage-Server-Storage-in-Windows-Server-Essentials.md)  

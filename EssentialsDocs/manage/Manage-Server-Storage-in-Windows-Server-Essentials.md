...
-   [Introducción a espacios de almacenamiento](Manage-Server-Storage-in-Windows-Server-Essentials.md#BKMK_5)  
...
|---------------|-----------------|  
|**Ver las propiedades de la unidad de disco duro**|Se abre el *Nombredediscoduro* **propiedades** página. Esta tarea se muestra cuando se selecciona la unidad de disco duro. La pestaña **General** de la página Propiedades de *NombreDeUnidadDeDiscoDuro* incluye las siguientes tareas adicionales:<br /><br /> -   **Limpieza de unidad**:  Permite limpiar los archivos no usados en el disco duro (esta tarea solo está disponible en Windows Server Essentials).<br />-   **Comprobar y reparar**:  Comprueba si la unidad de disco duro tiene errores en el sistema de archivos e intenta reparar automáticamente los errores detectados.<br /><br /> El **instantáneas** pestaña de la *Nombredediscoduro* **propiedades** página permite habilitar las instantáneas. Esta pestaña también muestra la hora en la que está programada la ejecución de la próxima instantánea.|  
|**Administrar espacios de almacenamiento**|**Nota:** Para Windows Server Essentials, esta tarea solo se muestra cuando hay un espacio de almacenamiento existente.<br /><br /> Abre el panel de control de los **Espacios de almacenamiento**, desde el que puede crear y administrar grupos de almacenamiento y espacios de almacenamiento.|  
...
##  <a name="BKMK_2"></a> Aumentar el almacenamiento en el servidor  
...
-   **Formateado** Si el disco duro interno se formateó con NTFS o ReFS, el servidor le asigna una letra de unidad y el disco duro aparece en la pestaña **Unidades de disco duro** . Ahora puede crear o mover las carpetas de servidor a la nueva unidad de disco duro.  
  
-   **No tiene el formato** si el disco duro interno no está formateado, aparece la alerta siguiente: Una o varias unidades de disco duro sin formatear están conectadas al servidor. Use el siguiente procedimiento para formatear el disco duro.  
  
#### <a name="to-format-the-hard-disk"></a>Para formatear el disco duro  
  
1.  Abra el Panel.  
  
2.  En el panel de navegación, haga clic en el icono de alerta para iniciar el **Visor de alertas** en Windows Server Essentials, o la **supervisión del estado** ficha en Windows Server Essentials.  
...
###  <a name="BKMK_Clean"></a> Para limpiar la unidad de disco duro  
...
4.  En **< letraDeUnidad\> propiedades**, en el **General** , haga clic **Liberador de espacio en disco**.  
...
-   [Usar la nueva unidad de disco dura para almacenar las carpetas del servidor](Manage-Server-Storage-in-Windows-Server-Essentials.md#BKMK_4a)  
  
-   [Usar la nueva unidad de disco dura para almacenar las copias de seguridad de servidor](Manage-Server-Storage-in-Windows-Server-Essentials.md#BKMK_4b)  
  
-   [Use la nueva unidad de disco dura para aumentar la capacidad del grupo de almacenamiento](Manage-Server-Storage-in-Windows-Server-Essentials.md#BKMK_4c)  
  
###  <a name="BKMK_4a"></a> Usar la nueva unidad de disco dura para almacenar las carpetas del servidor  
...
> [!NOTE]
>  Si configura los espacios de almacenamiento en un servidor que ejecuta Windows Server Essentials, no se puede realizar un restablecimiento de fábrica con la **limpiar datos** opción. La solución de este problema consiste en quitar en primer lugar los espacios de almacenamiento y, a continuación, realizar un restablecimiento de fábrica con la opción **Limpiar datos**.  

...
1.  Desde un equipo que use Windows 7, Windows 8, Windows 8.1 o Windows 10, abra el **Panel de control** y, en la sección **Programas**, haga clic en **Ver actualizaciones instaladas**.  

...
| Ubicación de personalización de marca | Descripción | Nombre de la cadena | Valor de los datos |
|--|--|--|--|
...
| Icon | Nombre del archivo de icono para el vínculo de inicio de sesión. El archivo debe encontrarse en la misma carpeta que el archivo .xml. Las imágenes de icono deben ser de 16x16 píxeles y estar en formato. png. Si no proporciona un icono, se usa la imagen del icono de vínculo predeterminado. |

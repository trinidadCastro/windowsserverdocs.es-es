...
- [Migrar los servidores de puerta de enlace de escritorio remoto](#migrate-rd-gateway-servers)
- [Migrar los servidores de licencias de escritorio remoto](#migrate-rd-licensing-servers)

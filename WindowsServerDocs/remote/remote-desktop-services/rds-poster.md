...
Puede que nos hayas oído hablar de una nueva "infraestructura moderna" para Escritorio remoto. Quizás nos hayas escuchado utilizar la frase "RDmi". La frase que necesitas conocer es "Windows Virtual Desktop". Conoce esta nueva oferta de virtualización en [Microsoft 365 incorpora un escritorio moderno a Azure](https://azure.microsoft.com/blog/microsoft-365-adds-modern-desktop-on-azure/) y nuestra [presentación de Ignite 2018 en Windows Virtual Desktop](https://www.youtube.com/watch?v=_7G37PFYVe4). Windows Virtual Desktop está actualmente en versión preliminar privada.
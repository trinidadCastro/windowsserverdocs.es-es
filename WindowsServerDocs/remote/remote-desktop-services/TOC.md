...
### [Directrices de red](network-guidance.md)
### [Directrices de ajuste del tamaño de la máquina virtual](virtual-machine-recs.md)
...
### [Office 2016 en implementaciones de RDS y VDI](/deployoffice/rds-office-vdi-rdsh)
#### [Tratamiento de búsqueda de Outlook en entornos no persistentes](/deployoffice/rds-outlook-search)
#### [Entornos de OneDrive para la Empresa y VDI](/deployoffice/rds-onedrive-business-vdi)
...
### [Optimización de Windows 10, versión 2004, para un rol de Infraestructura de escritorio virtual (VDI)](rds-vdi-recommendations-2004.md)

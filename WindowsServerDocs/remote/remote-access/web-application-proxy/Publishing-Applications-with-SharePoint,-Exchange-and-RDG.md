...
|Exchange ActiveSync|Paso a través<br/> AD FS mediante el protocolo de autorización básica HTTP|| Para obtener más información, vea: https://docs.microsoft.com/windows-server/remote/remote-access/web-application-proxy/publishing-applications-using-ad-fs-preauthentication 
...
-   [Solución de problemas de Proxy de aplicación Web](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/dn770156(v=ws.11))  

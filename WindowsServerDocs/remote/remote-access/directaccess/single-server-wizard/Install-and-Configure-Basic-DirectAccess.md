...
-   [Paso 1: Configure la infraestructura básica de DirectAccess @ no__t-0. Este paso incluye la configuración de la red, del servidor, de DNS y de Active Directory.  
  
-   [Paso 2: Configure el servidor de DirectAccess básico @ no__t-0. Este paso incluye la configuración de equipos cliente de DirectAccess y la configuración de servidor.  
  
-   [Paso 3: Compruebe las implementaciones @ no__t-0. Incluye el procedimiento para comprobar la implementación.  

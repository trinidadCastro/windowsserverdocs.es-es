...
**Nota:** Windows Server 2016 combina DirectAccess y enrutamiento y acceso remoto (RRAS) en un solo rol de acceso remoto.  
...
Si un GPO en un servidor, cliente o servidor de aplicaciones de acceso remoto se ha eliminado por accidente, aparecerá el mensaje de error siguiente: **GPO <GPO name> no se encuentra**.  

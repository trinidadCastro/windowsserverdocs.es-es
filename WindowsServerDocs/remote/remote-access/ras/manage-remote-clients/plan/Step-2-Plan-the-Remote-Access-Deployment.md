...
description: Obtenga información acerca de cómo planear la configuración que usará el Asistente para la instalación de acceso remoto.
manager: brianlic
ms.topic: article

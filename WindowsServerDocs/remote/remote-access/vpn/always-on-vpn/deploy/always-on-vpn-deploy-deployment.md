...
description: Obtenga información sobre el flujo de trabajo para implementar Always On conexiones VPN para equipos cliente de Windows 10 Unidos a un dominio remoto.
ms.topic: article

...
- [**Previo** Más información sobre las características avanzadas de VPN de Always On @ no__t-0
- [**Nueva** Paso 1. Inicio de la planeación de la Always On la implementación de VPN](always-on-vpn-deploy-planning.md)
...
## <a name="step-5-configure-dns-and-firewall-settings-for-always-on-vpnvpn-deploy-dns-firewallmd"></a>[Paso 5. Configuración de DNS y firewall para Always On VPN @ no__t-0
...
## <a name="step-7-optional-configure-conditional-access-for-vpn-connectivityad-ca-vpn-connectivity-windows10md"></a>[Paso 7. Opta Configurar el acceso condicional para la conectividad VPN @ no__t-0
...
[Paso 1. Planear la Always On la implementación de VPN @ no__t-0: Antes de instalar el rol de servidor de acceso remoto en el equipo en el que está planeando usar como un servidor VPN. Después de la planeación adecuada, puede implementar Always On VPN y, opcionalmente, configurar el acceso condicional para la conectividad VPN mediante Azure AD.  

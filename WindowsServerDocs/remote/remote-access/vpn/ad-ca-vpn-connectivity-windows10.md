...
- [**Previo** Paso 6. Configurar las conexiones VPN de Always On del cliente de Windows 10](always-on-vpn/deploy/vpn-deploy-client-vpn-connections.md)
- [**Nueva** Paso 7.1. Configurar EAP-TLS para omitir la comprobación de la lista de revocación de certificados (CRL)](vpn-config-eap-tls-to-ignore-crl-checking.md)
...
## <a name="step-74-deploy-conditional-access-root-certificates-to-on-premises-advpn-deploy-cond-access-root-cert-to-on-premise-admd"></a>[Paso 7.4. Implementar certificados raíz de acceso condicional en AD @ no__t-0 local

...
| Unidad de estado sólido (SSD) | Capacidad >= 20 GB por estación + 40 GB para el sistema operativo host de Multipoint Services<p>IOPS de lectura/escritura aleatoria >= 3K por estación |

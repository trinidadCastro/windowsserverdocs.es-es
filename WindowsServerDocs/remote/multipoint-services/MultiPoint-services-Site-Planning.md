...
![Concentradores de canal de bajada](./media/WMS_diagram6.gif)
...
-   [Concentradores de canal de bajada](#downstream-hubs)
...
![Estaciones en cadena de margarita](./media/WMS_diagram5.gif)
...
### <a name="downstream-hubs"></a>Concentradores de canal de bajada
...
![Varias conexiones a Zero Client mediante USB](./media/WMS_diagram4.gif "WMS_diagram4")
...
## <a name="power-considerations"></a>Consideraciones energéticas
...
![Aula configurada como sala de conferencias](./media/WMS_LectureRoom.gif)

...
Solo aquellas máquinas que HGS conoce y que ejecutan una [directiva de integridad de código ](/windows/security/threat-protection/windows-defender-application-control/windows-defender-application-control) de confianza pueden iniciar VM blindadas.
...
[Novedades en la autenticación Kerberos para Windows Server 2012](/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/hh831747(v=ws.11))

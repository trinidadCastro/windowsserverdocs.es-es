...
2.  Crea los siguientes archivos con los detalles especificados:  
    ...
    -   Crea una carpeta en el escritorio que se llame Expresiones regulares. Crea un documento de texto en la carpeta **RegEx-SSN**. Escriba el siguiente contenido en el archivo y, después, guárdelo y ciérrelo:   

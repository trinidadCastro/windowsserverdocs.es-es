...
## <a name="step-3-use-file-management-tasks-to-automatically-protect-documents-with-ad-rms"></a><a name="BKMK_3"></a>Paso 3: uso de tareas de administración de archivos para proteger documentos automáticamente con AD RMS  
...
## <a name="step-4-view-the-results"></a><a name="BKMK_4"></a>Paso 4: visualización de los resultados  
...
## <a name="step-5-verify-protection-with-ad-rms"></a><a name="BKMK_5"></a>Paso 5: comprobación de la protección con AD RMS  

...
Las tecnologías de identidad y acceso permiten entornos de Active Directory seguros locales y solo en la nube e implementaciones híbridas donde algunas aplicaciones y servicios se hospedan en la nube y otros se hospedan de forma local.
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Novedades</h2>
                                            <p>Descubre las novedades de los Servicios de federación de Active Directory (AD FS)</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
          ...
          <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Privileged Access Management para Active Directory Domain Services y AD DS</h3><hr />
                        <p>Privileged Access Management (PAM) para Azure Active Directory Domain Services (AD DS) es una solución que se basa en Microsoft Identity Manager (MIM) y Windows Server.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Servicios de dominio de Active Directory</h3><hr />
                        <p>Documentación detallada de todas las funciones disponibles para AD DS en Windows Server.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Servicios de federación de Active Directory (AD FS)</h3><hr />
                        <p>Documentación detallada de todas las funciones disponibles para AD FS en Windows Server.</p>
                    </div>
                </div>
            </div>
        </div>

...
- Autenticación integrada de Windows que usa Negotiate (solo NTLM) para los puntos de conexión de WS-Trust que aceptan la autenticación integrada de Windows.

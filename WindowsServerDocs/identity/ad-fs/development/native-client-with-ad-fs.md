---
title: Crear una aplicación de cliente nativo con los clientes públicos de OAuth con AD FS 2016
description: Un tutorial que proporciona instrucciones sobre la creación de una aplicación cliente nativa mediante clientes públicos de OAuth y AD FS 2016
author: billmath
ms.author: billmath
ms.reviewer: anandy
manager: mtillman
...
ms.locfileid: "59846486"
---
# <a name="build-a-native-client-application-using-oauth-public-clients-with-ad-fs-2016"></a>Crear una aplicación de cliente nativo con los clientes públicos de OAuth con AD FS 2016

## <a name="overview"></a>Información general

En este artículo se muestra cómo crear una aplicación nativa que interactúa con una API Web protegidas por AD FS 2016.
...
2. El token de acceso se utiliza como un token de portador para autenticar al usuario al llamar al punto de conexión de Todolist de la API web TodoListService.
 Se utiliza en el ejemplo de aplicación para Azure AD aquí y, a continuación, modificarlo para AD FS 2016.
...
* Agregue la clave **ida: autoridad** con el valor que representan el AD servicio FS, el ejemplo, https://fs.contoso.com/adfs/
* Modificar **ida: ClientId** clave con el valor de la **aplicación nativa** página durante la creación del grupo de aplicaciones en AD FS. Para p. ej., 3f07368b-6efd-4f50-a330-d93853f4c855
* Modificar el **todo:TodoListBaseAddress** a la dirección base de la API Web, por ejemplo, https://localhost:44321/
* Establezca el valor de **ida: RedirectUri** para el valor que se coloque en la página de aplicación nativa durante Agregar grupo de aplicaciones en AD FS.
* Para facilitar la lectura se puede quitar / comment la clave para **ida: inquilino** y **ida: AADInstance**.

**MainWindow.xaml.cs**

* Quite la línea de aadInstance
...
* En la función **MainWindow**, cambiar la creación de instancias de authContext como
...
* Elimine la clave **ida: inquilino** como no se necesita

...
|------------------------------------------------------------|-----------------------------------------------|------------------------------------------------------------|----------|  
|http: \/ \/ contoso.com|http: \/ \/ contoso.com|VERDADERO|Coincidencia exacta|  
|http: \/ \/ contoso.com\/|http: \/ \/ contoso.com|VERDADERO|Se ignoran las barras diagonales finales|  
|http: \/ \/ contoso.com|http: \/ \/ contoso.com\/|VERDADERO|Se ignoran las barras diagonales finales|  
|http: \/ \/ contoso.com|http: \/ \/ contoso.com \/ HR|VERDADERO|URI1 no tiene ninguna ruta de acceso y coincide con el esquema y la autoridad para URI2|  
|http: \/ \/ contoso.com \/ HR|http: \/ \/ contoso.com \/ HR \/ Web|VERDADERO|Las primeras secciones de la ruta de acceso coinciden, URI1 no tiene una segunda sección de ruta de acceso.|  
|http: \/ \/ contoso.com \/ HR\/|http: \/ \/ contoso.com \/ HRW \/ Main|FALSO|La sección 1 de la ruta de acceso de URI1 no coincide con la sección 1 de la ruta de acceso de URI2|  
|http: \/ \/ contoso.com \/ HR|http: \/ \/ contoso.com|FALSO|URI1 tiene más secciones de ruta de acceso que URI2.|  
|http: \/ \/ contoso.com \/ HR|http: \/ \/ contoso.com \/ HRWeb|FALSO|Las primeras secciones de la ruta de acceso no coinciden.|  
|https: \/ \/ contoso.com|http: \/ \/ contoso.com|FALSO|Las partes del esquema no coinciden.|  
|http: \/ \/ STS.contoso.com|http: \/ \/ contoso.com|FALSO|Las partes de la autoridad no coinciden.|  
|http: \/ \/ contoso.com|http: \/ \/ STS.contoso.com|FALSO|Las partes de la autoridad no coinciden.|  

...
Crea esta regla creando primero la sintaxis que necesitas para tu operación mediante el lenguaje de reglas de notificaciones y pegando el resultado en el cuadro de texto que se proporciona en la plantilla enviar notificaciones mediante una regla personalizada en las propiedades de un proveedor de notificaciones TR. UST o una relación de confianza para usuario autenticado en el\-complemento de administración de AD FS en.  

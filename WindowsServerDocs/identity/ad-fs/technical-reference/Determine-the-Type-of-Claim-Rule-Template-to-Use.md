...
En la tabla siguiente se describen todos los tipos de plantillas de reglas de notificaciones que se pueden usar para crear reglas mediante el\-de AD FS de administración en, y las ventajas de usar un tipo de plantilla sobre otro.  

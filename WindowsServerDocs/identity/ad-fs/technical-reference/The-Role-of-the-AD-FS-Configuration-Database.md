...
La base de datos de configuración de AD FS almacena todos los datos de configuración que representan una sola instancia de Servicios de federación de Active Directory (AD FS) \(AD FS @ no__t-1 \(that es, el Servicio de federación @ no__t-3. La base de datos de configuración de AD FS define el conjunto de parámetros que un servicio de federación necesita para identificar asociados, certificados, almacenes de atributos, notificaciones y diversos datos sobre estas entidades asociadas. Puede almacenar estos datos de configuración en una Microsoft SQL Server® base de datos o en la característica \(WID @ no__t-1 de Windows Internal Database que se incluye con Windows Server® 2008, Windows Server 2008 R2 y Windows Server® 2012.  
...
WID usa un almacén de datos relacional y no tiene su propia interfaz de usuario de administración \(UI @ no__t-1. En su lugar, los administradores pueden modificar el contenido de la base de datos de configuración de AD FS mediante el uso de los cmdlets de AD FS de administración de no__t-0in, Fsconfig. exe o de Windows™ PowerShell.  
...
Si selecciona la opción stand @ no__t-0alone, WID se usa para almacenar una única instancia de la base de datos de configuración de AD FS. Esta instancia no se puede compartir entre varios servidores de federación. Está pensada solo para entornos de laboratorio de pruebas. Para obtener más información acerca de la opción de servidor de Federación stand @ no__t-0alone o cómo configurar una, consulte [servidor de Federación independiente con WID](https://technet.microsoft.com/library/gg982486.aspx) o [crear un servidor de Federación](https://technet.microsoft.com/library/ee913579.aspx)independiente.  
...
> [!NOTE]  
> Se permite migrar una base de datos de configuración de AD FS desde WID a una instancia de SQL Server. Para obtener más información sobre cómo hacerlo, vea [AD FS: Migre la base de datos de configuración de AD FS a SQL Server @ no__t-0 en el sitio wiki de TechNet.  
...
Puede crear la base de datos de configuración de AD FS mediante una única instancia de base de datos de SQL Server como almacén mediante la herramienta Fsconfig. exe @ no__t-0line. Usar una base de datos de SQL Server como base de datos de configuración de AD FS tiene algunas ventajas respecto a WID:  
...
-   Proporciona compatibilidad con características de la resolución de artefactos SAML y la detección de reproducción de tokens SAML/WS @ no__t-0Federation \(described por debajo de @ no__t-2.  

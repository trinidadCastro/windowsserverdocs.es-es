...
ESL solo está disponible para el nombre de usuario y las solicitudes de autenticación de contraseña que vienen a través de la extranet con el Proxy de aplicación Web o a 3rd party proxy. Cualquier proxy parte 3ª debe admitir el protocolo de MS-ADFSPIP para usarse en lugar de los Proxy de aplicación Web, como [F5 BIG-IP Access Policy Manager](https://devcentral.f5.com/s/articles/ad-fs-proxy-replacement-on-f5-big-ip-30191). Consulte la documentación de proxy de entidad 3rd para determinar si el proxy admite el protocolo MS-ADFSPIP.   
...
Para los eventos de bloqueo inteligente de la Extranet se escriban, ESL debe estar habilitado en modo 'sólo registro' o 'Aplicar' y está habilitada la auditoría de seguridad de AD FS.
...
**¿ESL funciona en intranet demasiado?**   

...
Mediante el uso de la plantilla de reglas de **transformación de notificaciones entrantes** en servicios de Federación de Active Directory (AD FS) \(AD FS @ no__t-2, puede seleccionar una notificaciones entrantes, cambiar su tipo de notificaciones y cambiar su valor de notificaciones. Por ejemplo, puede usar esta plantilla de reglas para crear una regla que envíe una notificaciones de rol con el mismo valor de notificaciones de una demanda de grupo entrante. También puede usar esta regla para enviar una notificación de grupo con un valor de notificación de compradores cuando haya una notificación de grupo entrante con un valor de Admins, o bien, solo puede enviar notificaciones de nombre principal de usuario \(UPN @ no__t-1 que terminen con @fabrikam.  

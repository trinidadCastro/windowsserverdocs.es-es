...
2.  El nombre alternativo del sujeto debe contener el valor **enterpriseregistration** seguido del nombre principal de usuario \(UPN @ no__t-2 sufijo de la organización, por ejemplo, **enterpriseregistration.Corp.contoso.com**.  
  
    > [!WARNING]  
    > Especifique el nombre alternativo del firmante si tiene previsto habilitar el servicio de registro de dispositivos \(DRS @ no__t-1 para Workplace Join.  

...
-   [Configurar el primer servidor de Federación en una nueva granja de servidores de Federación](Configure-a-Federation-Server.md#configure-the-first-federation-server-in-a-new-federation-server-farm)  

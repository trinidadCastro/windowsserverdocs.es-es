...
| |Agregar una cuenta profesional o educativa  |Unión a Azure AD  |Unión a un dominio de Windows 10    
| --- | --- |--- | --- |
...
|Tipo de confianza Azure AD|Unido al área de trabajo|Azure AD unida|Dominio asociado  |     
...
* [Uso de dispositivos Windows 10 en el área de trabajo](https://azure.microsoft.com/documentation/articles/active-directory-azureadjoin-windows10-devices/)  
...
[Únase a Windows 10 Mobile en Azure Active Directory](https://technet.microsoft.com/itpro/windows/manage/join-windows-10-mobile-to-azure-active-directory)  

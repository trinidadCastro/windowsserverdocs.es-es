...
## <a name="BKMK_7"></a>Puente de vínculo a sitios  
...
Los puentes de vínculos a sitios solo son necesarios si un sitio contiene un controlador de dominio que hospeda una partición de directorio que no se hospeda también en un controlador de dominio de un sitio adyacente, pero un controlador de dominio que hospeda esa partición de directorio se encuentra en uno o varios sitios de el bosque. Los sitios adyacentes se definen como dos o más sitios incluidos en un solo vínculo a sitios.  
...
## <a name="BKMK_10"></a>Almacenamiento en caché de pertenencia al grupo universal  

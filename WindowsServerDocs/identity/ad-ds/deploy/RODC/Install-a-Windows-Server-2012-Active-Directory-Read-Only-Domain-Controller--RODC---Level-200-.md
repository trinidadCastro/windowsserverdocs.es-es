...
## <a name="stage-rodc-windows-powershell"></a><a name=BKMK_StagePS></a>Fase del RODC de Windows PowerShell  
...
## <a name="attach-rodc-windows-powershell"></a><a name=BKMK_AttachPS></a>Adjunte RODC de Windows PowerShell  

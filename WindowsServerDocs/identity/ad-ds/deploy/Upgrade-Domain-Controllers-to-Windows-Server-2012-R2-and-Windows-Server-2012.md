...
- [Instalar Active Directory Domain Services (nivel 100)](https://technet.microsoft.com/library/hh472162.aspx)  
- [Instalar un nuevo bosque de Active Directory de Windows Server 2012 (nivel 200)](https://technet.microsoft.com/library/jj574166.aspx)  
- [Instalar un controlador de dominio de Windows Server 2012 de réplica en un dominio existente (nivel 200)](https://technet.microsoft.com/library/jj574134.aspx)  
- [Instalar un nuevo dominio de árbol o secundario de Windows Server 2012 Active Directory (nivel 200)](https://technet.microsoft.com/library/jj574105.aspx)  
- [Instalar un controlador de dominio de solo lectura (RODC) de Windows Server Active Directory 2012 (nivel 200)](https://technet.microsoft.com/library/jj574152.aspx)  
- [Guía paso a paso para configurar el controlador de dominio de Windows Server 2012 (en-US)](https://social.technet.microsoft.com/wiki/contents/articles/12370.step-by-step-guide-for-setting-up-windows-server-2012-domain-controller-en-us.aspx)  
...
|-----------|---------------|  
|[Workplace Join](https://technet.microsoft.com/library/dn280945.aspx)|Permite a los trabajadores de la información unir sus dispositivos personales a su compañía para tener acceso a los recursos y servicios de la compañía.|  
...
|[Servicios de federación de Active Directory (AD FS) (AD FS)](https://technet.microsoft.com/library/hh831502.aspx)|Agrega, entre otras cosas, la instalación de roles por medio del Administrador del servidor, una configuración de confianzas simplificada, una administración de confianzas automática y compatibilidad con el protocolo SAML.|  
...
|[Active Directory interfaz de usuario de la papelera de reciclaje](https://technet.microsoft.com/library/hh831702.aspx#ad_recycle_bin_mgmt)|El Centro de administración de Active Directory (ADAC) incorpora una característica de administración de GUI de la papelera de reciclaje que apareció inicialmente en Windows Server 2008 R2.|  
|[Active Directory cmdlets de Windows PowerShell para la replicación y la topología](https://technet.microsoft.com/library/hh831757.aspx)|Permite crear y administrar sitios, vínculos de sitios y objetos de conexión de Active Directory (entre otras muchas cosas) mediante Windows PowerShell.|  
|[Access Control dinámico](https://technet.microsoft.com/library/hh831717.aspx)|Nueva plataforma de autorización basada en notificaciones que mejora el modelo de control de acceso heredado.|  
...
|[Implementación rápida mediante la clonación del controlador de dominio virtual (DC)](https://technet.microsoft.com/library/hh831734.aspx#virtualized_dc_cloning)|Los controladores de dominio virtualizados se pueden implementar con enorme rapidez clonando los controladores de dominio virtuales existentes mediante cmdlets de Windows PowerShell.|  
|[Cambios en el grupo RID](https://technet.microsoft.com/library/jj574229.aspx)|Agrega nuevas cuotas y eventos de supervisión que protegen de un uso excesivo del grupo RID global. Duplica el tamaño del grupo RID global de manera opcional en caso de que el grupo original se agote.|  
...
- **Configuración del equipo | Directivas | Plantillas administrativas | Componentes de Windows | Windows Update | No reiniciar automáticamente con usuarios que han iniciado sesión**  
...
|**WSUS administrado**<br /><br />-Instalar actualizaciones una vez por semana<br />-Reinicie Fridays en 11 P.M.|Establecer equipos para instalar automáticamente e impedir el reinicio automático hasta la hora deseada<br /><br />**Directiva**: Configurar actualizaciones automáticas (habilitada)<br /><br />Configurar actualizaciones automáticas: 4-descarga automática y programación de la instalación<br /><br />**Directiva**: No reiniciar automáticamente con usuarios que han iniciado sesión (deshabilitado)<br /><br />**Fechas límite de WSUS**: establecer en viernes a las 23:00|  
|**WSUS administrado**<br /><br />-Escalonar instalaciones en distintas horas/días|Establecer grupos de destino para distintos grupos de equipos que deben actualizarse juntos<br /><br />Usar los pasos del escenario anterior<br /><br />Establecer distintas fechas límites para distintos grupos de destino|  
|**No administrado por WSUS: no se admiten las fechas límite**<br /><br />-Escalonar instalaciones en momentos diferentes|**Directiva**: Configurar actualizaciones automáticas (habilitada)<br /><br />Configurar actualizaciones automáticas: 4-descarga automática y programación de la instalación<br /><br />**Clave del registro:** Habilite la clave del registro que se describe en el artículo [2835627](https://support.microsoft.com/kb/2835627) de Microsoft KB.<br /><br />**Directivas** Retraso aleatorio de mantenimiento automático (habilitada)<br /><br />Establece **Retraso aleatorio de mantenimiento normal** en PT6H para indicar un retraso aleatorio de seis horas y así tener el siguiente comportamiento:<br /><br />-Las actualizaciones se instalarán en el tiempo de mantenimiento configurado más un retraso aleatorio<br /><br />-El reinicio de cada máquina tendrá lugar exactamente 3 días más tarde<br /><br />Como alternativa, establece una hora de mantenimiento distinta para cada grupo de equipos.|  
...
- **El LMHash está deshabilitado en las cuentas de usuario**
...
|[Endpoint Protection de System Center 2012](http://blogs.technet.com/b/configmgrteam/archive/2012/09/10/support-questions-about-windows-8-and-windows-server-2012.aspx)|System Center 2012 Endpoint Protection Service Pack 1 actualizará la matriz de compatibilidad de cliente de forma que incluya los siguientes sistemas operativos:<br /><br />-Windows 8 Pro<br />-Windows 8 Enterprise<br />-Windows Server 2012 Standard<br />-Windows Server 2012 Datacenter|  
|[Endpoint Protection de Forefront de System Center 2012](http://blogs.technet.com/b/configmgrteam/archive/2012/09/10/support-questions-about-windows-8-and-windows-server-2012.aspx)|FEP 2010 con el paquete acumulativo de actualizaciones 1 actualizará la matriz de compatibilidad de cliente de forma que incluya los siguientes sistemas operativos:<br /><br />-Windows 8 Pro<br />-Windows 8 Enterprise<br />-Windows Server 2012 Standard<br />-Windows Server 2012 Datacenter|  
...
|Windows Server Update Services 3.0|La actualización del artículo [2734608](https://support.microsoft.com/kb/2734608) de Knowledge base permite que los servidores que ejecutan Windows Server Update Services (WSUS) 3,0 SP2 proporcionen actualizaciones a los equipos que ejecutan Windows 8 o windows Server 2012: **Nota:** Los clientes con entornos independientes de WSUS 3,0 SP2 o System Center Configuration Manager 2007 entornos de Service Pack 2 con WSUS 3,0 SP2 requieren [2734608](https://support.microsoft.com/kb/2734608) para administrar correctamente equipos basados en Windows 8 o windows Server 2012 como clientes.|  
...
[Instalación e implementación de Windows Server 2012](https://technet.microsoft.com/library/hh831620.aspx)  

...
4.  Compruebe la configuración de seguridad. Para obtener más información, consulte [características desusadas y cambios de comportamiento relativos a AD DS en Windows Server 2016](../../../get-started\deprecated-features.md). 

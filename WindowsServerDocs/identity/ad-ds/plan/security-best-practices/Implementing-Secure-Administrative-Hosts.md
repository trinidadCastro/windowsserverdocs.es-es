...
**Computer \ directivas de Seguridad\directivas Locales\opciones de Options\Interactive: Requerir tarjeta inteligente @ no__t-0  
...
En este enfoque, puede emitir a los usuarios una única estación de trabajo física que esté bloqueada como se ha descrito anteriormente y en la que los usuarios de ti no tienen privilegios de acceso. Puede proporcionar conexiones Servicios de Escritorio remoto a máquinas virtuales hospedadas en servidores dedicados, lo que proporciona al personal de ti una máquina virtual que ejecuta el correo electrónico y otras aplicaciones de productividad, y una segunda máquina virtual configurada como el usuario host administrativo dedicado.  

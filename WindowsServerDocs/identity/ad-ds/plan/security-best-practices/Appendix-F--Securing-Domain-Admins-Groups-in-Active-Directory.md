...
2.  En el árbol de consola, expanda \<bosque\>\\dominios\\\<\>de dominio y, a continuación, **Directiva de grupo objetos** (donde \<bosque\> es el nombre del bosque y \<dominio\> es el nombre del dominio en el que desea establecer la Directiva de grupo).  
...
5.  En el panel de detalles, haga clic con el botón secundario en \<nombre de GPO\>y haga clic en **Editar**.  
...
5.  En el campo Nombre de **archivo** , escriba\<nombre de archivo **\>. bat** (donde \<nombre de archivo\> es el nombre del nuevo archivo por lotes).  

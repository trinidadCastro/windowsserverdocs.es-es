...
1.  Quite todos los miembros del grupo, con la posible excepción de la cuenta de administrador integrada para el dominio, siempre que se haya protegido como se describe en @no__t 0Appendix D: Protección de cuentas de administrador integradas en Active Directory @ no__t-0.  
...
2.  En el árbol de consola, expanda \<Forest @ no__t-1 @ no__t-2Domains @ no__t-3 @ no__t-4Domain @ no__t-5 y, a continuación, **Directiva de grupo objetos** (donde \<Forest @ no__t-8 es el nombre del bosque y \<Domain @ no__t-10 es el nombre del dominio donde desea establecer el directiva de grupo).  
...
4.  En el cuadro de diálogo **nuevo GPO** , escriba \<GPO Name @ no__t-2 y haga clic en **aceptar** (donde \<GPO Name @ no__t-5 es el nombre de este GPO).  
...
5.  En el panel de detalles, haga clic con el botón secundario en \<GPO Name @ no__t-1 y haga clic en **Editar**.  
...
13. En administración de directiva de grupo, vincule el GPO al servidor miembro y las unidades organizativas de la estación de trabajo haciendo lo siguiente:  
    ...
    1.  Desplácese hasta el \<Forest @ no__t-1\Domains @ no__t-2 @ no__t-3Domain @ no__t-4 (donde \<Forest @ no__t-6 es el nombre del bosque y \<Domain @ no__t-8 es el nombre del dominio en el que desea establecer el directiva de grupo).  
...
5.  En el campo Nombre de **archivo** , escriba **@no__t -2Filename\>.bat** (donde \<Filename @ no__t-5 es el nombre del nuevo archivo por lotes).  
...
4.  En el cuadro de diálogo **crear tarea** , escriba **\<Task Name @ no__t-3** (donde \<Task Name @ no__t-5 es el nombre de la nueva tarea).  

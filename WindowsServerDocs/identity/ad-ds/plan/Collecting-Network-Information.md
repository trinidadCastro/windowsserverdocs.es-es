...
> [!NOTE]  
> Además de las direcciones IP versión 4 (IPv4), Windows Server también admite prefijos de subred de IP versión 6 (IPv6). Para ver una hoja de cálculo que le ayude a enumerar los prefijos de subred IPv6, consulte [Appendix A: Ubicaciones y prefijos de subred @ no__t-0.  
...
Grabe las ubicaciones, los dominios que se representan en cada ubicación y el número de usuarios para cada dominio que se representa en cada ubicación. Para ver una hoja de cálculo que le ayude a enumerar los dominios y el número de usuarios que están representados en cada ubicación, consulte el artículo [sobre ayudas de trabajo para el kit de implementación de Windows Server 2003](https://go.microsoft.com/fwlink/?LinkID=102558), descarga de Job_Aids_Designing_and_Deploying_Directory_and_Security_Services. zip, y abra "dominios y usuarios en cada ubicación" (DSSTOPO_3. doc).  

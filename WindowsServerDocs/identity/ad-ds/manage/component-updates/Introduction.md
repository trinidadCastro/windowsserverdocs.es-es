...
|Active Directory: cada dominio|Administradores del dominio|Grupo Admins. del dominio (DA)|  
|Active Directory: dominio raíz del bosque|Administradores de organización|Grupo administradores de empresas (EA)|  

...
Se realiza una copia de seguridad sin protección por contraseña si se produce un error en la función ConvertTo-SecureString al utilizar el Backup-CARoleService con el parámetro-password.

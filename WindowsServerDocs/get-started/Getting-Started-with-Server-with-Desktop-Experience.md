...
### Evaluación
Puede obtener una copia de evaluación con una licencia para 180 días de Windows Server desde [Evaluaciones de Windows Server](https://www.microsoft.com/evalcenter/evaluate-windows-server-2016). Elige la opción **Windows Server 2016 | ISO de 64 bits** para la descarga, o puedes visitar **Windows Server 2016 | Laboratorio virtual**.

...
2. Ejecute **get-silvmhost**
   ...
   - Si no aparece como hosts **desconocido**, a continuación, vaya a 2 del problema. 
   d - si se muestran los hosts pero no hay ningún **datetime** bajo el **sondeo reciente** columna y, a continuación, vaya a **problema 2** a continuación.

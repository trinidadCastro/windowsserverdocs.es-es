...
|                             Tarea                              |                                                                                                                                                                                                                 Comando                                                                                                                                                                                                                 |
|---------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|             Establecer la contraseña administrativa local             |                                                                                                                                                                                                      \* de **Administrador de usuarios de red**                                                                                                                                                                                                      |
...
|         Agregar un usuario al grupo local Administradores          |                                                                                                                                                                                       **net localgroup Administrators/Add \<dominio\\nombredeusuario\>**                                                                                                                                                                                       |
|       Quitar un usuario del grupo Administradores local       |                                                                                                                                                                                     **net localgroup Administrators/Delete \<dominio\\nombredeusuario\>**                                                                                                                                                                                      |
|               Agregar un usuario al equipo local                |                                                                                                                                                                                                **net user \<dominio\nombre de usuario\> \*/Add**                                                                                                                                                                                                 |
|               Agregar un grupo al equipo local               |                                                                                                                                                                                                 **net localgroup \<nombre de grupo\>/Add**                                                                                                                                                                                                  |
|          Cambiar el nombre de un equipo unido a un dominio          |                                                                                                                                                           **netdom renamecomputer% COMPUTERNAME%/NewName:\<nuevo nombre de equipo\>/userd:\<dominio\\nombre de usuario\>/passwordd:** \*                                                                                                                                                            |
...
|                               Tarea                                |                                                                                                                               Comando                                                                                                                                |
|-------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                         Instalar una actualización                         |                                                                                                                    **WUSA \<actualización\>. msu/Quiet**                                                                                                                    |
|                      Mostrar las actualizaciones instaladas                       |                                                                                                                            **systeminfo**                                                                                                                            |
|                         Quitar una actualización                          |                                 **Expanda/f:\* \<Update\>. msu c:\test** <br>Vaya a c:\test\ y abra \<Update\>. XML en un editor de texto.<br>Reemplace **instalar** con **quitar** y guarde el archivo.<br>**PkgMgr/n:\<actualizar\>. XML**                                 |
...
|                          Detener un servicio                          |                                                                                                                                                                                  **SC stop \<nombre del servicio\>** o **net stop \<nombre del servicio\>**                                                                                                                                                                                   |
...
|Consultar eventos en un registro especificado|**wevtutil qe/f: Text \<nombre de registro\>**| 
|Exportar un registro de eventos|**EPL de wevtutil \<nombre de registro\>**| 

...
2. Ejecute **Rename-Computer-ComputerName \<new_name @ no__t-2**.
3. Reinicie el equipo.

### <a name="activate-the-server"></a>Activar el servidor

Ejecute **slmgr. vbs – IPK @ no__t-1productkey @ no__t-2**. A continuación, ejecute **slmgr. vbs – ATO**. Si la activación se realiza correctamente, no recibirá ningún mensaje.
...
|                             Tarea                              |                                                                                                                                                                                                                 Comando                                                                                                                                                                                                                 |
|---------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|             Establecer la contraseña administrativa local             |                                                                                                                                                                                                      @no__t de **Administrador de usuarios de red** -1                                                                                                                                                                                                      |
|                  Unir un equipo a un dominio                  |                                                                                                                                                       **netdom join% COMPUTERNAME%** **/Domain: \<domain @ no__t-3/userd: \<domain @ no__t-5username @ no__t-6/passwordd:** \* <br> Reinicie el equipo.                                                                                                                                                        |
|              Confirmar que el dominio ha cambiado              |                                                                                                                                                                                                                 **set**                                                                                                                                                                                                                 |
|                Quitar un equipo de un dominio                |                                                                                                                                                                                                   **Netdom Remove \<computername @ no__t-2**                                                                                                                                                                                                    |
|         Agregar un usuario al grupo local Administradores          |                                                                                                                                                                                       **net localgroup Administrators/Add \<domain @ no__t-2username @ no__t-3**                                                                                                                                                                                       |
|       Quitar un usuario del grupo Administradores local       |                                                                                                                                                                                     **net localgroup Administrators/Delete \<domain @ no__t-2username @ no__t-3**                                                                                                                                                                                      |
|               Agregar un usuario al equipo local                |                                                                                                                                                                                                **net user \<domain \ nombredeusuario @ no__t-2 \*/Add**                                                                                                                                                                                                 |
|               Agregar un grupo al equipo local               |                                                                                                                                                                                                 **net localgroup \<group nombre @ no__t-2/Add**                                                                                                                                                                                                  |
|          Cambiar el nombre de un equipo unido a un dominio          |                                                                                                                                                           **netdom renamecomputer% COMPUTERNAME%/NewName: \<New nombre de equipo @ no__t-2/userd: \<Domain @ no__t-4username @ no__t-5/passwordd:** \*                                                                                                                                                            |
|                 Confirmar el nuevo nombre de un equipo                 |                                                                                                                                                                                                                 **set**                                                                                                                                                                                                                 |
|         Cambiar el nombre de un equipo en un grupo de trabajo         |                                                                                                                                                                **Netdom renamecomputer \<currentcomputername @ no__t-2/NewName: \<newcomputername @ no__t-4** <br>Reinicie el equipo.                                                                                                                                                                 |
|                Deshabilitar la administración de archivos de paginación                 |                                                                                                                                                                        **WMIC ComputerSystem donde name = "\<computername @ no__t-2" Set AutomaticManagedPagefile = false**                                                                                                                                                                         |
|                   Configurar el archivo de paginación                   |                                                            **WMIC pagefileset Where name = "\<path/FILENAME @ no__t-2" Set InitialSize = \<initialsize @ no__t-4, Tamañomáximo = \<maxsize @ no__t-6** <br>Donde *path/FILENAME* es la ruta de acceso y el nombre del archivo de paginación, *initialsize* es el tamaño inicial del archivo de paginación, en bytes, y *MaxSize* es el tamaño máximo del archivo de paginación, en bytes.                                                             |
|                 Cambiar a una dirección IP estática                 | **ipconfig/all** <br>Grabe la información relevante o redirijala a un archivo de texto (**ipconfig/all > ipconfig. txt**).<br>**netsh interface IPv4 show interfaces**<br>Compruebe que haya una lista de interfaces.<br>**netsh interface IPv4 Set Address Name \<ID from interface List @ no__t-2 Source = static Address = \<preferred IP address @ no__t-4 Gateway = \<gateway Address @ no__t-6**<br>Ejecute **ipconfig/all** para comprobar que DHCP habilitado está establecido en **no**. |
|                   Establezca una dirección DNS estática.                   |   <strong>netsh interface IPv4 Add dnsserver Name = \<name o ID de la tarjeta de interfaz de red @ no__t-2 Address = \<IP dirección del servidor DNS principal @ no__t-4 index = 1 <br></strong>netsh interface IPv4 Add dnsserver Name = \<name del servidor DNS secundario @ no__t-2 Address = \<IP dirección del servidor DNS secundario @ no__t-4 index = 2 @ no__t-5 @ no__t-6 <br> Repita los pasos necesarios para agregar más servidores.<br>Ejecute **ipconfig/all** para comprobar que las direcciones son correctas.   |
| Cambiar una dirección IP estática por una dirección IP proporcionada por DHCP |                                                                                                                                      **netsh interface IPv4 Set Address Name = \<IP dirección del sistema local @ no__t-2 Source = DHCP** <br>Ejecute **ipconfig/all** para comprobar que DCHP habilitado está establecido en **sí**.                                                                                                                                      |
|                      Escribir una clave de producto                      |                                                                                                                                                                                                   **slmgr. vbs – IPK \<Product Key @ no__t-2**                                                                                                                                                                                                    |
|                  Activar el servidor de forma local                  |                                                                                                                                                                                                           **slmgr. vbs-ATO**                                                                                                                                                                                                            |
|                 Activar el servidor de forma remota                  |                                            **cscript slmgr. vbs – IPK \<Product Key @ no__t-2 @ no__t-3server Name @ no__t-4 @ no__t-5username @ no__t-6 @ no__t-7password @ no__t-8** <br>**cscript slmgr. vbs-ATO \<servername @ no__t-2 \<username @ no__t-4 \<password @ no__t-6** <br>Obtener el GUID del equipo mediante la ejecución de **cscript slmgr. vbs-DID** <br> Ejecutar **cscript slmgr. vbs-dli \<GUID @ no__t-2** <br>Compruebe que el estado de la licencia está establecido en con **licencia (activada)** .                                             |

### <a name="networking-and-firewall"></a>Funciones de red y firewall

|Tarea|Comando| 
|----|-------|
|Configurar el servidor para que use un servidor proxy|**netsh WinHTTP Set proxy \<servername @ no__t-2: \<Port número @ no__t-4** <br>**Nota:** Las instalaciones Server Core no pueden tener acceso a Internet a través de un proxy que requiera una contraseña para permitir conexiones.|
|Configurar el servidor para omitir el proxy para direcciones de Internet|**netsh WinHTTP Set proxy \<servername @ no__t-2: \<Port número @ no__t-4 bypass-List = "\<local @ no__t-6"**| 
...
|                               Tarea                                |                                                                                                                               Comando                                                                                                                                |
|-------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                         Instalar una actualización                         |                                                                                                                    **WUSA @no__t -1update\>.msu/Quiet**                                                                                                                    |
|                      Mostrar las actualizaciones instaladas                       |                                                                                                                            **systeminfo**                                                                                                                            |
|                         Quitar una actualización                          |                                 **Expanda/f: \* @no__t -2update\>.msu c:\test** <br>Vaya a c:\test\ y abra @no__t -0update\>.xml en un editor de texto.<br>Reemplace **instalar** con **quitar** y guarde el archivo.<br>**PkgMgr/n: @no__t -1update\>.xml**                                 |
|                    Configurar actualizaciones automáticas                    |          Para comprobar la configuración actual: **cscript%SystemRoot%\SYSTEM32\SCREGEDIT.wsf/au/v \* @ no__t-2 @ no__t-3To habilitar actualizaciones automáticas: \* @ no__t-5cscript scregedit. wsf/au 4** <br>Para deshabilitar las actualizaciones automáticas: **cscript%SystemRoot%\SYSTEM32\SCREGEDIT.wsf/au 1**          |
|                      Habilitar los informes de errores                       | Para comprobar la configuración actual: **serverWerOptin/Query** <br>Para enviar automáticamente informes detallados: **serverWerOptin/Detailed** <br>Para enviar automáticamente informes de Resumen: **serverWerOptin/Summary** <br>Para deshabilitar los informes de errores: **serverWerOptin/Disable** |
...
|                         Iniciar un servicio                          |                                                                                                                                                                                 **SC start \<service Name @ no__t-2** o **net start \<service Name @ no__t-5**                                                                                                                                                                                  |
|                          Detener un servicio                          |                                                                                                                                                                                  **SC stop \<service Name @ no__t-2** o **net stop \<service Name @ no__t-5**                                                                                                                                                                                   |
...
|    Crear y administrar registros de rendimiento y sesión de seguimiento de eventos    | Para crear un contador, un seguimiento, una colección de datos de configuración o una API: **Logman creación** <br>Para consultar las propiedades del recopilador de datos: **Logman Query** <br>Para iniciar o detener la recopilación de datos: **Logman Start @ no__t-1STOP** <br>Para eliminar un recopilador: **Logman Delete** <br> Para actualizar las propiedades de un recopilador: **Logman Update** <br>Para importar un conjunto de recopiladores de datos desde un archivo XML o exportarlo a un archivo XML: **Logman Import @ no__t-1export** |
...
|Consultar eventos en un registro especificado|**wevtutil qe/f: Text \<LOG Name @ no__t-2**| 
|Exportar un registro de eventos|**wevtutil EPL \<LOG Name @ no__t-2**| 
|Borrar un registro de eventos|**wevtutil cl \<LOG nombre @ no__t-2**| 
...
| Convertir un volumen en un sistema de archivos NTFS |        **Convert \<Volume letra @ no__t-2/FS: NTFS**         |
...
|Tarea|Comando| 
|----|-------|
|Agregar un controlador para un nuevo dispositivo de hardware|Copie el controlador en una carpeta en la carpeta% HOMEDRIVE% \\ @ no__t-1driver @ no__t-2. Ejecute **pnputil-i-a% HOMEDRIVE% \\ @ no__t-2driver carpeta @ no__t-3 @ no__t-4 @ no__t-5driver\>.inf**|
|Quitar un controlador de un dispositivo de hardware|Para obtener una lista de los controladores cargados, ejecute **sc query Type = driver**. Después, ejecute **SC delete \<service_name @ no__t-2**|

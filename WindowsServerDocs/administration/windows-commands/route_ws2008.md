...
|\<Command >|Especifica el comando que se desea ejecutar. En la tabla siguiente se enumeran los comandos válidos:<br /><br />-   **Add:** agrega una ruta.<br />-   **Change:** modifica una ruta existente.<br />-   **Delete:** elimina una ruta o rutas.<br />-   **Print:** imprime una ruta o rutas.|  

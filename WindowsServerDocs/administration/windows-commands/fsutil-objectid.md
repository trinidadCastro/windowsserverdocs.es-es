...
description: Tema de referencia del comando fsutil objectId, que administra los identificadores de objeto para realizar el seguimiento de otros objetos, como archivos, directorios y vínculos.

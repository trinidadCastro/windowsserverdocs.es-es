...
```
El ejemplo siguiente se muestra cómo utilizar la ** ** protectores de comando para deshabilitar la protección hasta que reinicie el equipo 3 veces.
```

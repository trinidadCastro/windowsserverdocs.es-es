...
description: Tema de referencia para el comando net Print. Este comando está en desuso y no se garantiza que se admita en versiones futuras de Windows.

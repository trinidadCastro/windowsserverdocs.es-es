---
title: tsprof
description: Temas de comandos de Windows para tsprof, que copia la información de configuración de usuario de Servicios de Escritorio remoto de un usuario a otro.

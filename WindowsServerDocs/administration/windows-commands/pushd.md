---
title: pushd
description: Tema de referencia para el comando Inserted, que almacena el directorio actual para que lo use el comando popd y, a continuación, cambia al directorio especificado.

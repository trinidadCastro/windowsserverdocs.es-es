...
|-noInheritAcl|Aplica los permisos de la lista de control de acceso (ACL) que corresponden a las credenciales proporcionadas por los parámetros **-User** y **-password** a \\ @ no__t-3 @ no__t-4servername > \\ @ no__t-6sharename > @no__ t-7WindowsImageBackup @ no__t-8 @ no__t-9ComputerBackedUp > 0 (la carpeta que contiene la copia de seguridad). Para tener acceso a la copia de seguridad más adelante, debe usar estas credenciales o ser miembro del grupo administradores o del grupo operadores de copia de seguridad en el equipo con la carpeta compartida. Si no se usa **-noInheritAcl** , los permisos de la ACL de la carpeta compartida remota se aplican a la carpeta \\ @ No__t-2ComputerBackedUp > de forma predeterminada para que todos los usuarios con acceso a la carpeta compartida remota puedan tener acceso a la copia de seguridad.|
...
Escenario #1
- Cree una copia de seguridad de volúmenes e:, d: \\mountpoint y \\ @ no__t-2? \\Volume {cc566d14-4410-11d9-9d93-806e6f6e6963}
- Guarde la copia de seguridad en el volumen f:
  ```
  wbadmin start backup -backupTarget:f: -include:e:,d:\mountpoint,\\?\Volume{cc566d14-44a0-11d9-9d93-806e6f6e6963}\
  ```
  Escenario #2
- Realice una copia de seguridad única de *f: \\folder1* y *h: \\folder2* al volumen *d:* .
...
- Realice una copia de seguridad de la carpeta en la ubicación de red *\\ @ no__t-2backupshare @ no__t-3backup1*

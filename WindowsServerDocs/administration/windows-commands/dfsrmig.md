---
title: dfsrmig
description: El tema comandos de Windows para dfsrmig, que migra la replicación de SYSvol desde el servicio de replicación de archivos (FRS) a la replicación de Sistema de archivos distribuido (DFS), proporciona información sobre el progreso de la migración y modifica objetos de servicios de dominio de Active Directory (AD DS) para admitir la migración.

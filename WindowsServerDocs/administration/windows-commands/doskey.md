...
|[/insert | /overstrike]|Especifica si se debe insertar o sobrescribir el texto a medida que escribe. Si usas **/inserción**, se inserta texto nuevo que escriba en una línea en mitad del texto existente. Si usas **//overstrike**, reemplaza el texto nuevo texto existente. El valor predeterminado es **//overstrike**.|
...
-   Creación de una macro
    ...
    |$B o $b|Envía los resultados de la macro a un comando. Estos caracteres especiales son equivalentes a utilizar la barra vertical (**|*) en una línea de comandos.|

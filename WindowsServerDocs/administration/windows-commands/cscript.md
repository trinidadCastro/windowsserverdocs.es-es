---
title: cscript
description: Tema de referencia de cscript, que inicia un script para que se ejecute en un entorno de línea de comandos.
...
|     H<Seconds>     |            Especifica el tiempo máximo que se puede ejecutar el script (en segundos). Puede especificar hasta 32.767 segundos. El valor predeterminado es sin límite de tiempo.             |
...
-   Puede establecer propiedades para scripts individuales.
-   Windows Script Host puede usar archivos de script. wsf. Cada archivo. wsf puede usar varios motores de scripting y realizar varios trabajos.

...
description: Tema de referencia de Remove-DriverGroup, que quita un grupo de controladores de un servidor.
...
|---------|-----------|
|/DriverGroup:\<nombre de grupo>|Especifica el nombre del grupo de controladores que se va a quitar.|

...
|      /Scope {usuario &#124; equipo}       |                                Muestra datos RSoP para el usuario o el equipo. Si se omite **/Scope** , **Gpresult** muestra los datos de RSoP para el usuario y el equipo.                                 |
...
- El comando **Gpresult** está disponible en windows Server 2012, windows Server 2008 R2, Windows Server2008, Windows 8, Windows 7 y Windows Vista.
  ...
  Para recuperar los datos RSoP para el usuario remoto **targetusername** del equipo **srvmain**y muestra los datos RSoP sobre el usuario únicamente. El comando se ejecuta con las credenciales del usuario **maindom\hiropln**y <strong>p@ssW23</strong> se escribe como la contraseña para ese usuario.

  ```
  gpresult /s srvmain /u maindom\hiropln /p p@ssW23 /user targetusername /scope user /r
  ```
  
Para guardar toda la información disponible sobre directiva de grupo para el **targetusername** de usuario remoto del equipo **srvmain** a un archivo denominado **Policy. txt**. No se incluyen datos sobre el equipo. El comando se ejecuta con las credenciales del usuario **maindom\hiropln**y <strong>p@ssW23</strong> se escribe como la contraseña para ese usuario.

  ```
  gpresult /s srvmain /u maindom\hiropln /p p@ssW23 /user targetusername /z > policy.txt
  ```
  
Para mostrar los datos de RSoP para el equipo **srvmain** y el usuario que ha iniciado sesión. Los datos se incluyen tanto para el usuario como para el equipo. El comando se ejecuta con las credenciales del usuario **maindom\hiropln**y <strong>p@ssW23</strong> se escribe como la contraseña para ese usuario.

...
description: Artículo de referencia de WDSUtil add-device, que preconfigura un equipo en servicios de dominio de Active Directory. Los equipos preconfigurados también se denominan equipos conocidos.
ms.topic: reference

---
title: certreq
description: El tema comandos de Windows para CertReq, que solicita certificados de una entidad de certificación (CA), recupera una respuesta a una solicitud anterior de una CA, crea una nueva solicitud desde un archivo. inf, acepta e instala una respuesta a una solicitud, construye una solicitud de certificación cruzada o de subordinación completa desde un certificado o una solicitud de CA existente y firma una solicitud de certificación cruzada o de subordina
...
ms.locfileid: "80848218"
---
# <a name="certreq"></a>certreq

CertReq se puede usar para solicitar certificados de una entidad de certificación (CA), para recuperar una respuesta a una solicitud anterior de una CA, para crear una nueva solicitud desde un archivo. inf, para aceptar e instalar una respuesta a una solicitud, para construir una solicitud de certificación cruzada o de subordinación cualificada a partir de un certificado o una solicitud de CA existente, y para firmar una solicitud de

> [!WARNING]
> Es posible que las versiones anteriores de CertReq no proporcionen todas las opciones que se describen en este documento. Puede ver todas las opciones que proporciona una versión específica de CertReq; para ello, ejecute los comandos que se muestran en la sección notación de sintaxis. CertReq no admite la creación de una nueva solicitud de certificado basada en una plantilla de atestación de clave en un entorno de procesamiento de eventos complejos/CES
...
## <a name="syntax-notations"></a><a name=BKMK_notation></a>Notación de sintaxis
...
-   Si utiliza -config - en lugar de -config NombreEquipoEntidadCertificación\NombreEntidadCertificación, la operación se procesa utilizando la entidad de certificación predeterminada.
...
|FriendlyName|Un nombre descriptivo para el nuevo certificado.|Texto|FriendlyName = Servidor1|
...
|    *funcionando*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                                        *continue* = UPN =User@Domain.com&                                                                                                                                                                                                                                                                                                                                                                                                         |
|    *funcionando*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                                       *continue* = EMail =User@Domain.com&                                                                                                                                                                                                                                                                                                                                                                                                        |
|    *funcionando*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                                        *continue* = DNS = host. dominio. com &                                                                                                                                                                                                                                                                                                                                                                                                         |
|    *funcionando*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                               *continue* = DIRECTORYNAME = CN = Name, DC = Domain, DC = com &                                                                                                                                                                                                                                                                                                                                                                                               |
|    *funcionando*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                             *continue* = URL =<http://host.domain.com/default.html&>                                                                                                                                                                                                                                                                                                                                                                                              |
|    *funcionando*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                                         *continue* = IPAddress = 10.0.0.1 &                                                                                                                                                                                                                                                                                                                                                                                                         |
|    *funcionando*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                                       *continue* = RegisteredId = 1.2.3.4.5 &                                                                                                                                                                                                                                                                                                                                                                                                       |
|    *funcionando*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                                      *continue* = 1.2.3.4.6.1 = {Utf8} cadena &                                                                                                                                                                                                                                                                                                                                                                                                      |
|    *funcionando*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                                  *continue* = 1.2.3.4.6.2 = {octet} AAECAwQFBgc = &                                                                                                                                                                                                                                                                                                                                                                                                   |
|    *funcionando*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                          *continue* = 1.2.3.4.6.2 = {octet} {Hex} 00 01 02 03 04 05 06 07 &                                                                                                                                                                                                                                                                                                                                                                                           |
|    *funcionando*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                                 *continue* = 1.2.3.4.6.3 = {ASN} BAgAAQIDBAUGBw = = &                                                                                                                                                                                                                                                                                                                                                                                                  |
|    *funcionando*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                           *continue* = 1.2.3.4.6.3 = {Hex} 04 08 00 01 02 03 04 05 06 07                                                                                                                                                                                                                                                                                                                                                                                            |
|    2.5.29.37     |            |       |                                                                                                                                                                                                                                                                                                                                                                                                                 2.5.29.37 = {Text}                                                                                                                                                                                                                                                                                                                                                                                                                 |
|    *funcionando*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                                            *continue* = 1.3.6.1.5.5.7.                                                                                                                                                                                                                                                                                                                                                                                                            |
|    *funcionando*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                                          *continue* = 1.3.6.1.5.5.7.3.1                                                                                                                                                                                                                                                                                                                                                                                                          |
...
## <a name="certreq--policy"></a><a name=BKMK_policy></a>CertReq: Directiva
...
## <a name="certreq--enroll"></a><a name=BKMK_enroll></a>CertReq: inscribirse
...
## <a name="options"></a><a name=BKMK_Options></a>Opciones
...
## <a name="formats"></a><a name=BKMK_Formats></a>Aplique
...
## <a name="additional-certreq-examples"></a><a name=BKMK_Examples></a>Ejemplos adicionales de CertReq

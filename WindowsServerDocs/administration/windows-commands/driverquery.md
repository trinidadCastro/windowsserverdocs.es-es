...
| /u [\<Domain > \] @ no__t-2 | Ejecuta el comando con las credenciales de la cuenta de usuario según lo especificado por el *usuario* o el *dominio*\*User @ no__t-3. De forma predeterminada, \* @ no__t-1/s @ no__t-2 @ no__t-3 usa las credenciales del usuario que ha iniciado sesión actualmente en el equipo que emite el comando. **/u** no se puede usar a menos que se especifique **/s** . |

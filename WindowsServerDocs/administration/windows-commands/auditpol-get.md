...
description: El tema comandos de Windows para **Auditpol Get** -recupera la Directiva del sistema, la Directiva por usuario, las opciones de auditoría y el objeto de descriptor de seguridad de auditoría.
ms.custom: na
...
> Para recuperar el estado Enabled, Disabled o 2 de la opción CrashOnAuditFail, escriba:
> ```

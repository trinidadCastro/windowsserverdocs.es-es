...
| SD =<SDDL string> | Establece el filtro de usuario en el disco duro virtual. La cadena de filtro debe estar en el formato de lenguaje de definición de descriptores de seguridad (SDDL). De forma predeterminada, el filtro de usuario permite el acceso como en un disco físico.<br /><br />Las cadenas SDDL pueden ser complejas, pero en su forma más simple, un descriptor de seguridad que protege el acceso se conoce como una lista de control de acceso discrecional (DACL). Tiene el formato: D: < dacl_flags > < string_ace1 > < string_ace2 >... < string_acen ><br /><br />Las marcas DACL comunes son:<br /><br />-   **un permiso de** acceso<br />-   **D** denegar el acceso<br /><br />Los derechos comunes son:<br /><br />-   **GA** All Access<br />acceso de lectura de -   **gr**<br />acceso de escritura de -   **GW**<br /><br />Las cuentas de usuario comunes son:<br /><br />-   **BA** integrado en los administradores<br />usuarios autenticados de -   **au**<br />propietario de -   **Co** Creator<br />-   **WD** -Everyone<br /><br />Ejemplos:<br /><br />**D:P: (A;; GR;;; AU** proporciona acceso de lectura a todos los usuarios autenticados<br /><br />**D:P: (A;; GA;;; WD** permite que todo el mundo tenga pleno alcance |

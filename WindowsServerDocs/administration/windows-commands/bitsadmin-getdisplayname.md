...
description: Tema de los comandos de Windows para **bitsadmin getdisplayname** -recupera el nombre para mostrar del trabajo especificado.
ms.custom: na

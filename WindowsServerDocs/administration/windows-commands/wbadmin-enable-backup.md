...
|-contraseña|En Windows Server 2008 R2 y versiones posteriores, especifica la contraseña para el nombre de usuario proporcionado por el parámetro-user.|

...
> [!IMPORTANT]
> Este comando no se admite para su uso en equipos que ejecutan Windows 8, Windows Server 2012 o sistemas operativos posteriores. Para esos equipos, puede usar el [cmdlets de administración de TPM de Windows PowerShell](https://technet.microsoft.com/library/jj603116.aspx).
...
```
El ejemplo siguiente se muestra cómo utilizar la ** comando tpm ** para tomar posesión de TPM y establecer la contraseña de propietario en 0wnerP@ss.
```

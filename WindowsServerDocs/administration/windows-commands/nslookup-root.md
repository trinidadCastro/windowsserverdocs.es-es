---
title: nslookup root
description: Tema de referencia del comando Nslookup root, que cambia el servidor predeterminado al servidor para la raíz del espacio de nombres de dominio del sistema de nombres de dominio (DNS).

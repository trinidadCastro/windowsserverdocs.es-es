...
|        identificador de \<\>        |                                                                                                                                                                                   Especifica el número de identificación asignado a un comando programado.                                                                                                                                                                                   |
...
- Tareas que se detienen después de 72 horas  
  ...
  3.  En el menú Edición, haga clic en agregar valor y, a continuación, agregue el siguiente valor del registro: nombre del valor: atTaskMaxHours tipo de datos: reg_DWOrd base: datos del valor decimal: 0. Un valor de 0 en el campo de datos de valor indica que no hay límite, no se detiene. Los valores del 1 al 99 indican el número de horas.
  **Precaución**

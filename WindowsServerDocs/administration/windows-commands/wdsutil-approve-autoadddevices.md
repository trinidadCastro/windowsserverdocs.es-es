...
description: Artículo de referencia para WDSUtil APPROVE-AutoAddDevices, que aprueba equipos que están pendientes de aprobación administrativa.
ms.topic: reference

...
description: Tema de referencia del comando Logman Update Trace, que actualiza las propiedades de un recopilador de datos de seguimiento de eventos existente.

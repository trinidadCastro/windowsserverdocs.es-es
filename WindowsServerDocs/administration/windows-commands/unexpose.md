---
title: x:.
description: Tema de referencia sobre la anulación de la exposición, que anula la exposición de una instantánea que se expuso mediante el comando exponer.
...
|\<Unidad: >|Anula la exposición de la instantánea asociada a la letra de unidad especificada (por ejemplo, la unidad P).|

...
- Se determinan las rutas de acceso del contador que se van a usar en función del propio contador. Por ejemplo, el objeto LogicalDisk tiene una instancia <Index>de, por lo que debe proporcionar el < # index> o un carácter comodín. Por lo tanto, puede usar el siguiente formato **: \LogicalDisk\*/\*#\*(\\ )***  
...
-   Use el parámetro **/t** para especificar que los archivos de entrada se inserten en los archivos de <n>salida a intervalos de cada uno de los registros. De forma predeterminada, los datos se reinician desde cada registro.  

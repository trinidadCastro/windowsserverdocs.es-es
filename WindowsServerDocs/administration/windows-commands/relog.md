...
-   Use el parámetro **/t** para especificar que los archivos de entrada se inserten en los archivos de salida a intervalos de cada uno de los <n> registros. De forma predeterminada, los datos se reinician desde cada registro.

...
ms.locfileid: "71374858"
---
# <a name="manage-bde-changepin"></a>Manage-BDE: changepin



Modifica el PIN de una unidad del sistema operativo. Se solicita al usuario que escriba un nuevo PIN. Para obtener ejemplos de cómo se puede usar este comando, vea [ejemplos](#BKMK_Examples).
...
En el ejemplo siguiente se muestra el uso del comando **-changepin** para cambiar el PIN que se usa con BitLocker en la unidad C.
```

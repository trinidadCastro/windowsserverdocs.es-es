...
description: Tema de comandos de Windows para New-Imagendedetección, que crea una nueva imagen de detección a partir de una imagen de arranque existente.

...
## <a name="BKMK_1"></a>Para configurar un puerto de comunicaciones serie
...
## <a name="BKMK_3"></a>Para redirigir la salida de un puerto paralelo a un puerto de comunicaciones serie
...
## <a name="BKMK_4"></a>Para seleccionar, actualizar o mostrar los números de las páginas de códigos de la consola
...
## <a name="BKMK_5"></a>Para cambiar el tamaño del búfer de pantalla del símbolo del sistema

...
|[{/oa | /od | /os | on}]|Especifica cómo se muestran los resultados de la operación de comparación. El valor predeterminado es **/od**. Consulte las siguientes opciones específicas.|

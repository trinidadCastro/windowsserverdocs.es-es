...
description: Tema de referencia para el subcomando set-Server, que configuró los valores para un servidor de servicios de implementación de Windows.
...
[: Start-](subcommand-start-server.md)

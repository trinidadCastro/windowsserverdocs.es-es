...
description: Tema de comandos de Windows para el subcomando set-Server, que configuró la configuración de un servidor de servicios de implementación de Windows.

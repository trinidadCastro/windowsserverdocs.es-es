...
description: Temas de comandos de Windows para add-device, que preconfigura un equipo en servicios de dominio de Active Directory. Los equipos preconfigurados también se denominan equipos conocidos.
...
[usar el comando get-AllDevices](using-the-get-alldevices-command.md)

...
selecciona el disco duro virtual especificado \(VHD @ no__t-1 y desplaza el foco a él.  
...
|-------|--------|  
|archivo @ no__t-0 @ no__t-1|Especifica la ruta de acceso completa y el nombre de un archivo VHD existente.|  

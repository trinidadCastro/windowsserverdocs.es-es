---
title: Con el comando remove-DriverPackages
...
ms.locfileid: "59872486"
---
# <a name="using-the-remove-driverpackages-command"></a>Con el comando remove-DriverPackages
...
Para quitar los paquetes, escriba uno de los siguientes:
```

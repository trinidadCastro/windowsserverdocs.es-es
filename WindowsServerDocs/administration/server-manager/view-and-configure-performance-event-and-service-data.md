...
-   [Visualizar y configurar eventos](#BKMK_events)
...
4.  En el campo **Orígenes del evento**, seleccione los orígenes del evento sobre los cuales desea recibir alertas. El valor predeterminado es **Todos**.

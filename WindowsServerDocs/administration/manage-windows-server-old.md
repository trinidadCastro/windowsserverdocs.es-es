...
## <a name="automate-windows-server-management"></a>Automatiza la administración de Windows Server
...
### <a name="windows-commandswindows-commandswindows-commandsmd"></a>[Comandos de Windows](windows-commands/windows-commands.md)

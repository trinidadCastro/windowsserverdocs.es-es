...
description: 'Tema de Windows Server Update Service (WSUS): información general sobre el proceso de implementación con vínculos a los cuatro pasos para lograrlo'
...
En una implementación de WSUS, al menos un servidor WSUS de la red debe conectarse a Microsoft Update para obtener información sobre actualizaciones disponibles. Puede determinar, en función de la seguridad y la configuración de la red, el número de servidores que se conectan directamente a Microsoft Update.  

En esta guía se proporciona información conceptual para planear e implementar Windows Server Update Service.  

...
| Sizing | Cada nodo de servidor HGS de tamaño medio (8 núcleos/4 GB) puede administrar hosts de Hyper-V 1.000. |
...
| Sistema operativo | Se recomienda usar la opción Server Core para el sistema operativo del host de Hyper-V. |

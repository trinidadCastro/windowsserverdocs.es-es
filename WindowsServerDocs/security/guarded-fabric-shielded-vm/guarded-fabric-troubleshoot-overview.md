...
En los temas siguientes se explica cómo solucionar problemas de un tejido protegido:

- [Solución de problemas con la herramienta de diagnóstico de tejido protegido](guarded-fabric-troubleshoot-diagnostics.md)
- [Solución de problemas del servicio de protección de host](guarded-fabric-troubleshoot-hgs.md)

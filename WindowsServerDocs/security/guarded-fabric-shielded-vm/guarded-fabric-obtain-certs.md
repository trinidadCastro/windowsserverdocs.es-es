...
-------------------------|---------------
Nombre de sujeto             | Nombre del clúster de HGS (nombre de red distribuida). Esta será la concatenación del nombre del servicio HGS proporcionada a `Initialize-HgsServer` y el nombre de dominio de HGS.

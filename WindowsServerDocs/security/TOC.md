...
## [Configurar HGS para máquinas virtuales blindadas y tejido protegido](guarded-fabric-shielded-vm/guarded-fabric-and-shielded-vms-top-node.md)
...
### [Implementar](guarded-fabric-shielded-vm/guarded-fabric-deploying-hgs-overview.md)
...
#### [Máquinas virtuales blindadas](guarded-fabric-shielded-vm/guarded-fabric-troubleshoot-shielded-vms.md)
## [Atestación de estado de dispositivo](device-health-attestation.md)
...
### [What's New in Credential Protection (Novedades de la protección de credenciales)](credentials-protection-and-management/whats-new-in-credential-protection.md)
...
### [Grupo de seguridad de usuarios protegidos](credentials-protection-and-management/protected-users-security-group.md)
...
### [Tareas iniciales con Cuentas de servicio administradas de grupo](group-managed-service-accounts/getting-started-with-group-managed-service-accounts.md)
...
### [Delegación limitada de Kerberos](kerberos/kerberos-constrained-delegation-overview.md)

...
> [!NOTE]
> La implementación del lado cliente de RFC 5077 se agregó en Windows 8.
...
Para obtener información sobre la administración de certificados mediante el proveedor de PowerShell, consulte [cmdlets de administración de AD CS en Windows](https://technet.microsoft.com/library/hh848365(v=wps.620).aspx).
...
-   [Modelo de seguridad de la nube privada: funcionalidad de contenedor](https://social.technet.microsoft.com/wiki/contents/articles/6756.private-cloud-security-model-wrapper-functionality.aspx)

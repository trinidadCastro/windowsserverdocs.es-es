...
![Captura de pantalla que muestra el bloqueo de aplicaciones de la pantalla](../media/winlogon-automatic-restart-sign-on-arso/GTR_ADDS_LockScreen.gif)  
...
![Captura de pantalla que muestra la configuración de directiva controla la interfaz de usuario donde puedes especificar si un dispositivo se automáticamente sesión del último usuario interactivo reiniciar el sistema de Windows Update](../media/winlogon-automatic-restart-sign-on-arso/GTR_ADDS_SignInPolicy.gif)  

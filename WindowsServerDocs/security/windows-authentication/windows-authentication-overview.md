...
|Kerberos|[Información general sobre la autenticación Kerberos](../kerberos/kerberos-authentication-overview.md)<br /><br />[Introducción a la delegación restringida de Kerberos](../kerberos/kerberos-constrained-delegation-overview.md)<br /><br />[Referencia técnica de autenticación Kerberos](https://technet.microsoft.com/library/cc739058(v=ws.10).aspx)\(2003\)<br /><br />[Guía de supervivencia de Kerberos](https://social.technet.microsoft.com/wiki/contents/articles/4209.kerberos-survival-guide.aspx) \(TechNet wiki\)|
|Proveedor de compatibilidad con seguridad Schannel\/SSL y DTLS \(Schannel\)|[Información general de &#40;TLS-&#41; SSL Schannel SSP](../tls/tls-ssl-schannel-ssp-overview.md)<br /><br />[Referencia técnica del proveedor de compatibilidad con seguridad de Schannel](../tls/schannel-security-support-provider-technical-reference.md)|

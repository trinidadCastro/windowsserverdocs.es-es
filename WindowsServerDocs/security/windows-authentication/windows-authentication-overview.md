...
|Autenticación para una aplicación o un servicio web|Autenticación integrada de Windows<p>Autenticación implícita|Para obtener recursos adicionales, vea los temas acerca de la [autenticación integrada de Windows](/previous-versions/windows/it-pro/windows-server-2003/cc758557(v=ws.10)), la [autenticación implícita](/previous-versions/windows/it-pro/windows-server-2003/cc738318(v=ws.10)) y la [autenticación implícita avanzada](/previous-versions/windows/it-pro/windows-server-2003/cc783131(v=ws.10)).|

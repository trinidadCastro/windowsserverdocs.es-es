...
Cuando se usa la formación de equipos NIC, la creación de varias interfaces de equipo permite a un host conectarse a distintas VLAN al mismo tiempo.
Configure el entorno con las siguientes directrices:

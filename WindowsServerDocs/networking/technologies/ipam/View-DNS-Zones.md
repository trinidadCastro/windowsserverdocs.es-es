...
ms.locfileid: "59841526"
---
# <a name="view-dns-zones"></a>Visualización de zonas DNS

>Se aplica a: Windows Server (canal semianual), Windows Server 2016

Puede utilizar este tema para ver las zonas DNS en la consola de cliente IPAM.  
  
El requisito mínimo para realizar este procedimiento es la pertenencia al grupo **Administradores** o grupo equivalente.  
  
### <a name="to-view-dns-zones-in-the-ipam-client-console"></a>Para ver las zonas DNS en la consola de cliente IPAM  

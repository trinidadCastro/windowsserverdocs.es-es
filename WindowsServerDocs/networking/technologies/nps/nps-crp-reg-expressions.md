...
**Para reemplazar <em>user@example.microsoft.com</em> por *example. Microsoft. com\user***
...
**Para reemplazar *dominio\usuario* por *specific_domain\user***

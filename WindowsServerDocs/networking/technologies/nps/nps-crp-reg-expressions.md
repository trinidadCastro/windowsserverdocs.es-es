...
**Para reemplazar <em>user@example.microsoft.com</em> con *example.microsoft.com\user***
...
<strong>Para reemplazar *usuario* con *user@specific_domain</strong>*

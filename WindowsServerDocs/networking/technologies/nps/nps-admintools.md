...
2. En **escritorio remoto**, haga clic en **permitir conexiones remotas a este equipo**. Se abrirá el cuadro de diálogo **conexión a escritorio remoto** . Lleve a cabo cualquiera de las siguientes opciones.
...
Para llevar a cabo este procedimiento, debe ser miembro del grupo Administradores en el equipo local.
...
- [Cmdlets del servidor de directivas de redes (NPS) en Windows PowerShell](https://technet.microsoft.com/library/jj872739(v=wps.630).aspx). Puede usar estos comandos Netsh en Windows Server 2012 R2 o sistemas operativos posteriores.
- [Módulo NPS](https://technet.microsoft.com/itpro/powershell/windows/nps/index). Puede usar estos comandos Netsh en Windows Server 2016.

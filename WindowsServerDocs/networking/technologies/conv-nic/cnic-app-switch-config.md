...
1.  en \( ir al modo de administración, normalmente pide una contraseña.\)
2.  configuración \( para entrar en el modo de configuración\)
3.  Mostrar ejecución \( muestra la configuración actual en ejecución\)
...
13. Mostrar ejecución \( Compruebe que la configuración está configurada correctamente en los puertos\)

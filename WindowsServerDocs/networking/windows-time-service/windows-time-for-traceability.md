...
|---|---|
|Mecanismo de limitación  |Ninguna.<p>Esto debería ocurrir con poca frecuencia en sistemas con una sincronización razonable de la hora, y queremos que se registre cada vez que tenga lugar. Omitimos el valor de TimeJumpAuditOffset al registrar este evento, ya que la configuración se diseñó para limitar los eventos del registro de eventos del sistema Windows. |

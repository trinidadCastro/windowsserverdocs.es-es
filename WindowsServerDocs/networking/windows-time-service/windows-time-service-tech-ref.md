...
El servicio W32Time proporciona sincronización de reloj de red para los equipos sin necesidad de una configuración extensa. El servicio W32Time es esencial para el correcto funcionamiento de la autenticación Kerberos V5 y, por lo tanto, en la autenticación basada en AD DS. Cualquier aplicación compatible con Kerberos, incluida la mayoría de los servicios de seguridad, se basa en la sincronización de la hora entre los equipos que participan en la solicitud de autenticación. AD DS controladores de dominio también deben tener relojes sincronizados para ayudar a garantizar una replicación de datos precisa.

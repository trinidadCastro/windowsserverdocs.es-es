...
##### [Introducción a la implementación de certificados de servidor](core-network-guide/cncg/server-certs/Server-Certificate-Deployment-Overview.md)
##### [Planeación de la implementación de certificados de servidor](core-network-guide/cncg/server-certs/Server-Certificate-Deployment-Planning.md)
...
###### [Mover y cambiar el tamaño de la memoria caché hospedada (opcional)](core-network-guide/cncg/bc-hcm/6-Bc-move-Resize-Cache.md)
...
###### [Configurar la detección automática de caché hospedada cliente mediante el punto de conexión de servicio](core-network-guide/cncg/bc-hcm/10-Bc-Client-By-Scp.md)
...
######### [Crear la unidad organizativa (OU) de servidores de archivos de BranchCache](branchcache/deploy/create-the-BranchCache-File-Servers-Organizational-Unit.md)
...
##### [Implementar servidores de caché hospedada (opcional)](branchcache/deploy/deploy-hosted-cache-servers.md)
...
##### [Configurar los equipos cliente de BranchCache](branchcache/deploy/Configure-BranchCache-Client-computers.md)
...
####### [Configuración de reglas de firewall para miembros que no son de dominio para permitir el tráfico de BranchCache](branchcache/deploy/Configure-Firewall-Rules-for-Non-Domain-Members-to-Allow-BranchCache-Traffic.md)
...
### [Novedades del cliente DNS en Windows Server](dns/What-s-New-in-DNS-Client.md)
### [Novedades del servidor DNS en Windows Server](dns/What-s-New-in-DNS-Server.md)
### [Guía de escenarios de la directiva DNS](dns/deploy/DNS-Policy-Scenario-Guide.md)
#### [Introducción a las directivas DNS](dns/deploy/DNS-Policies-Overview.md)
...
### [Puente de centro de datos \(DCB\)](technologies/dcb/dcb-top.md)
...
## [Conmutador virtual de Hyper-V](technologies/vswitch-stub.md)
...
##### [Crear una zona DNS](technologies/ipam/create-a-DNS-Zone.md)
...
##### [Administrar el control de acceso basado en roles con Windows PowerShell](technologies/ipam/Manage-Role-Based-Access-Control-with-Windows-powershell.md)
...
#### [Plantillas de NPS](technologies/nps/nps-templates.md)
...
#### [Configurar las directivas de solicitud de conexión](technologies/nps/nps-crp-configure.md)
...
#### [Administrar NPSs](technologies/nps/nps-manage-servers.md)
...
#### [Administrar plantillas de NPS](technologies/nps/nps-manage-templates.md)
...
### [Configurar el orden de las interfaces de red](technologies/network-subsystem/net-sub-interface-metric.md)
### [Adaptadores de red de ajuste de rendimiento](technologies/network-subsystem/net-sub-performance-tuning-nics.md)
...
#### [Redes de contenedores](sdn/technologies/Containers/Container-networking-overview.md)

### [Plan para SDN](sdn/plan/Plan-a-Software-Defined-Network-Infrastructure.md)
#### [Instalación y requisitos de preparación para la implementación de una controladora de red](sdn/plan/Installation-and-Preparation-Requirements-for-Deploying-Network-Controller.md)

### [Implementar SDN](sdn/deploy/Deploy-Software-Defined-Networking.md)
#### [Implementar una infraestructura SDN](sdn/deploy/Deploy-a-Software-Defined-Network-Infrastructure.md)
...
##### [Crear, eliminar o actualizar redes virtuales de inquilinos](sdn/manage/create,-delete,-or-Update-Tenant-Virtual-Networks.md)
...
##### [Usar dispositivos de red virtual en una red virtual](sdn/manage/Use-Network-Virtual-Appliances-on-a-VN.md)
...
## [Redes privadas virtuales (VPN)](technologies/vpn-stub.md)

## [Servicio WINS (WINS)](technologies/wins/wins-top.md)
...
#### [Cómo funciona el servicio de hora de Windows](windows-time-service/How-the-Windows-Time-Service-Works.md)
#### [Configuración y herramientas del servicio de hora de Windows](windows-time-service/Windows-Time-Service-Tools-and-Settings.md)

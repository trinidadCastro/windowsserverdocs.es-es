...
2.  En la consola de administración de directivas de grupo, expanda la ruta de acceso siguiente: **Bosque:** *example.com*, **dominios**, *example.com*, **Directiva de grupo objetos**, donde *example.com* es el nombre del dominio donde se encuentran las cuentas de equipo cliente de BranchCache que desea configurar.  
...
5.  En la consola de Editor de administración de directivas de grupo, expanda la siguiente ruta de acceso: **Configuración del equipo**, **Directivas**, **Plantillas administrativas: Definiciones de directivas (archivos ADMX) recuperadas del equipo local @ no__t-0, **red**, **BranchCache**.  
...
1.  En la consola de administración de directivas de grupo, expanda la ruta de acceso siguiente: **Bosque:** *example.com*, **dominios**, *example.com*, **Directiva de grupo objetos**, donde *example.com* es el nombre del dominio donde se encuentran las cuentas de equipo cliente de BranchCache que desea configurar.  

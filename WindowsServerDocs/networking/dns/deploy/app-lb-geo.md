...
## <a name="how-to-configure-application-load-balancing-with-geo-location-awareness"></a>Cómo configurar el equilibrio de carga de la aplicación con reconocimiento de ubicación geográfica

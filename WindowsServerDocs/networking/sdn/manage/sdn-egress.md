...
## <a name="example-manage-the-unbilled-address-ranges-of-a-virtual-network"></a>Ejemplo: Administrar los intervalos de direcciones no facturado de una red virtual

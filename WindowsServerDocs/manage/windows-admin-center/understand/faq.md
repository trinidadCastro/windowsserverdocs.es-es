...
Sí. Windows Admin Center generalmente está disponible y listo para implementaciones amplias de uso y de producción. Como plataforma que seguirá creciendo y madurando, la salida de la versión preliminar significa que las capacidades de la plataforma actual y las principales herramientas cumplen los criterios de versión estándar de Microsoft y nuestra barra de calidad de facilidad de uso, confiabilidad, rendimiento, accesibilidad, seguridad y adopción.
...
* Esta versión es para administradores de TI que no pueden actualizar con frecuencia o que desean más tiempo de validación para las versiones que se utilizan en producción. Nuestra versión (GA) disponible con carácter general actual es Windows Admin Center 1809.5.
* Para obtener la versión más reciente de disponibilidad general, [descárgala aquí](https://aka.ms/WACDownload).

* Disponibilidad general de Windows Admin Center se admiten versiones continuamente, basándose en Microsoft [directiva de ciclo de vida moderno](https://support.microsoft.com/help/30881/modern-lifecycle-policy). Esto significa que solo se atiende y admite la última versión de disponibilidad general de Windows Admin Center y los usuarios deben "Manténgase al día" mediante la actualización a la última versión de disponibilidad general de Windows Admin Center dentro de 30 días de disponibilidad siga siendo compatible. Esta directiva se aplica a la misma plataforma de Windows Admin Center, así como las extensiones de Microsoft que GA y se publican en la extensión de Windows Admin Center fuente. Tenga en cuenta que algunas extensiones se pueden actualizar con más frecuencia que otros usuarios, entre las versiones de Windows Admin Center GA.

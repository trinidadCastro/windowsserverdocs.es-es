...
- **Mejoras en el testigo del recurso compartido de archivos** Habilitamos el uso de un testigo de recurso compartido de archivos en los escenarios siguientes: 

...
Puede ver las relaciones de elementos primarios y secundarios en el resultado de `Get-ClusterFaultDomain` , en las `ParentName` `ChildrenNames` columnas y.

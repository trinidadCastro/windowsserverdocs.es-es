...
- Copie el archivo \(DefaultHotfixConfig. XML que se proporciona en la **carpeta% SystemRoot\\%\\system32\\WindowsPowerShell v\\1.0\\modules ClusterAwareUpdating** de un equipo en el que las herramientas\) de la Cau están instaladas en la carpeta raíz de revisiones que creó y en la que extrajo las revisiones. Por ejemplo, copie el archivo de configuración * \\ \\\\en la\\raíz\\de revisiones de mi fileserver*. 
...
-   **Modo\-de actualización remota** Cuenta que tiene privilegios administrativos en el clúster para obtener una vista previa de las actualizaciones y aplicarlas.  
...
Opcionalmente, puede deshabilitar las comprobaciones anteriores que realiza\-el complemento de forma predeterminada. Puede hacerlo de una de las maneras siguientes:  

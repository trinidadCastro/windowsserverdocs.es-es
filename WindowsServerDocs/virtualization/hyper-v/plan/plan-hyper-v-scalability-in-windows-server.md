...
|-------------|-----------|---------|  
|Puntos de comprobación|50|El número real puede ser menor, ya que depende del almacenamiento disponible. Cada punto de control se almacena como un archivo. avhd que usa el almacenamiento físico.|  
...
|Componente|Máximo|Notas|  
|-------------|-----------|---------|  
|Procesadores lógicos|512|Ambos deben estar habilitados en el firmware:<br /><br />-Virtualización asistida por hardware<br />-Prevención de ejecución de datos (DEP) forzada por hardware<br /><br />El sistema operativo del host (partición raíz) solo verá los procesadores lógicos 320 máximos|  

...
description: Obtenga información acerca de qué hacer cuando una máquina virtual que ejecuta Windows 7 está configurada con menos de la cantidad de RAM recomendada, que es 1 GB.
ms.author: benarm

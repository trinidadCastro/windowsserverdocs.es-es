...
description: Obtenga información acerca de qué hacer cuando una máquina virtual que ejecuta Windows Server 2016 se configura con menos de la cantidad de RAM recomendada, que es 1 GB.
ms.author: benarm

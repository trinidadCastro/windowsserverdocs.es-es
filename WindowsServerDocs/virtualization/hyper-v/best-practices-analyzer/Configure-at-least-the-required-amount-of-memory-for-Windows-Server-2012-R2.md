---
title: Configure al menos la cantidad necesaria de memoria para una máquina virtual que ejecuta Windows Server 2012 R2 y habilitado para la memoria dinámica
...
ms.locfileid: "59881296"
---
# <a name="configure-at-least-the-required-amount-of-memory-for-a-virtual-machine-running-windows-server-2012-r2-and-enabled-for-dynamic-memory"></a>Configure al menos la cantidad necesaria de memoria para una máquina virtual que ejecuta Windows Server 2012 R2 y habilitado para la memoria dinámica
...
*Una o más máquinas virtuales se configuran para utilizar memoria dinámica con menor que la cantidad de memoria necesaria para Windows Server 2012 R2.*  

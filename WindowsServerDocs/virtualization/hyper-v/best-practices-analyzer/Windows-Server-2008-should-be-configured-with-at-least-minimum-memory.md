...
description: Obtenga información acerca de qué hacer cuando una máquina virtual que ejecuta Windows Server 2008 se configura con menos de la cantidad mínima de RAM, que es de 512 MB.
ms.author: benarm

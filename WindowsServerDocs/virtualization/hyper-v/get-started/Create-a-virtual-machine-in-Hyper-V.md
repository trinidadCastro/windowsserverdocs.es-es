...
4.  Tomar las decisiones adecuadas para la máquina virtual en cada una de las páginas. Para obtener más información, consulte [nuevas opciones de la máquina virtual y los valores predeterminados en el Administrador de Hyper-V](#options-in-hyper-v-manager-new-virtual-machine-wizard) más adelante en este tema.  
...
## <a name="create-a-virtual-machine-by-using-windows-powershell"></a>Crear una máquina virtual con Windows PowerShell  
...
## <a name="options-in-hyper-v-manager-new-virtual-machine-wizard"></a>Opciones de Asistente de máquina Virtual nueva de administrador de Hyper-V  

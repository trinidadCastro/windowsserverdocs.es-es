...
-   [Aplicar seguridad de nivel de aplicación](#bkmk_enforce)  
  
-   [Exigir la seguridad de nivel de usuario y de nivel de aplicación](#bkmk_both)  
  
-   [Proporcionar compatibilidad de seguridad a una aplicación que no es TCP/UDP](#bkmk_tcp)  

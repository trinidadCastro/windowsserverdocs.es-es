...
- autenticación de 802.1 x. el \( \) conmutador virtual de Hyper V quita automáticamente los paquetes EAP del Protocolo de autenticación extensible 802.1 x \- en los escenarios establecidos.

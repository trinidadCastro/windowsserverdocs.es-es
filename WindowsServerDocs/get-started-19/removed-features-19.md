...
> - ¿Tienes preguntas acerca de otras versiones? Consulte la información para [Windows Server, versión 1803](../get-started/windows-server-1803-removed-features.md), [Windows Server, versión 1709](../get-started/removed-features-1709.md), y [Windows Server 2016](../get-started/deprecated-features.md).
...
|Servicio de nombres de almacenamiento de Internet (iSNS)|Se usa el protocolo iSNS para la interacción entre servidores iSNS y clientes. [Bloque de mensajes del servidor](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/hh831795\(v=ws.11\)) proporciona esencialmente la misma funcionalidad, así como otras características.|

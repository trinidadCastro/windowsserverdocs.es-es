...
description: 'Explicación de los canales de mantenimiento de Windows Server: LTSC y SAC'
...
ms.locfileid: "9149771"
---
# Las ramas de mantenimiento de Windows Server: LTSC y SAC
...
|  | Canal de mantenimiento a largo plazo (Windows Server 2019) |Canal semianual (WindowsServer) |
| ------------------- | ------------------------------------ | ------------------------------------------------- |
...
A menos que se indique lo contrario, los requisitos mínimos de hardware para ejecutar los lanzamientos del canal semianual serán los mismos que para la versión más reciente del canal de mantenimiento a largo plazo de WindowsServer. Por ejemplo, **la versión actual del canal de mantenimiento a largo plazo es Windows Server 2019**. La mayoría de los controladores de hardware seguirán funcionando en estas versiones.
...
## Obtener las versiones preliminares mediante el Programa Windows Insider
...
## Para identificar Windows Server 2019 y Windows Server, versión 1809
...
**Ejemplo de Windows Server, versión 1809 (SAC) Standard Edition Server Core:**
...
[Cambios en NanoServer en el Canal semianual de WindowsServer](../get-started/nano-in-semi-annual-channel.md)

[Ciclo de vida de soporte técnico de WindowsServer](https://support.microsoft.com/lifecycle)

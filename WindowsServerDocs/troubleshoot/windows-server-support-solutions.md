...
- [Resolver errores de actualización de Windows10: información técnica para profesionales de TI](\windows\deployment\upgrade\resolve-windows-10-upgrade-errors)
- [Actualización de la pila de mantenimiento de Windows 10, versión 1607 y Windows Server 2016: 8 de agosto de 2017](https://support.microsoft.com/en-US/help/4035631)
- [Actualización de compatibilidad de actualización de Windows 10, versión 1607 y Windows Server 2016: 3 de agosto de 2017](https://support.microsoft.com/en-US/help/4033524)
- [No se admite una actualización del sistema en máquinas virtuales de Azure basadas en Windows](https://support.microsoft.com/en-US/help/4014997)
...
- [Códigos de error de activación para activación por volumen](https://technet.microsoft.com/library/dn502528.aspx)
- [Cómo solucionar problemas del Servicio de administración de claves (KMS)](https://technet.microsoft.com/library/ee939272.aspx)
- [Solución de problemas de activación por volumen](https://technet.microsoft.com/library/ff793439.aspx)
- [Códigos de error de activación](https://technet.microsoft.com/library/ff793399.aspx)
- [La instalación de Windows puede producir un error que indique "La clave del producto especificada no coincide con ninguna de las imágenes de Windows disponibles para la instalación. Escribe otra clave del producto"](https://support.microsoft.com/help/2796988/windows-8-or-windows-server-2012-installation-may-fail-with-error-mess)
...
- [Requisitos de puerto de Active Directory y Active Directory Domain Services](https://technet.microsoft.com/library/dd772723(v=ws.10).aspx)
- [Puertos de Firewall de Active Directory: vamos a probar para facilitar esta operación](http://blogs.msmvps.com/acefekay/2011/11/01/active-directory-firewall-ports-let-s-try-to-make-this-simple/)
- [Soporte de Exchange Server para Windows Server 2016](https://technet.microsoft.com/library/ff728623(v=exchg.150).aspx)
- [Utilizar Ntdsutil.exe para asumir o transferir las funciones de FSMO a un controlador de dominio](http://support.microsoft.com/kb/255504)
...
- [Solución de problemas del Asistente para instalación de Active Directory](https://msdn.microsoft.com/library/bb727058.aspx)
- [Problemas conocidos a la hora de instalar y quitar AD DS](https://technet.microsoft.com/library/cc754463(v=ws.10).aspx)

## <a name="solutions-for-active-directory-federation-services-ad-fs"></a>Soluciones de Servicios de federación de Active Directory (ADFS)
...
- [Configurar la emisión de notificaciones](/azure/active-directory/device-management-hybrid-azuread-joined-devices-setup#step-2-setup-issuance-of-claims)
...
- [Proteger contra ataques de contraseñas](https://blogs.technet.microsoft.com/tspring/2017/01/20/federated-to-microsoft-cloud-and-account-lockouts/)
- [Actualizar a AD FS en Windows Server 2016 mediante una base de datos WID](../identity/ad-fs/deployment/upgrading-to-ad-fs-in-windows-server-2016.md)
...
- [Administrar certificados SSL en AD FS y WAP en Windows Server 2016](../identity/ad-fs/operations/manage-ssl-certificates-ad-fs-wap-2016.md)
- [Directivas de control de acceso en AD FS para Windows Server 2016](../identity/ad-fs/operations/access-control-policies-in-ad-fs.md)
...
- [Descargar la herramienta Active Directory Replication Status en el Centro de descarga de Microsoft](http://www.microsoft.com/en-in/download/details.aspx?id=30005)
- [e2e: Cómo solucionar problemas comunes de replicación de Active Directory](http://support.microsoft.com/kb/3108513)
- [Solución de problemas al aparecer el error de replicación de AD 8606: no se especificaron atributos suficientes para crear un objeto](http://support.microsoft.com/kb/2028495)
- [Los identificadores de eventos 2108 y 1084 se producen durante la replicación de entrada de Active Directory en Windows 2000 Server y en Windows Server 2003](http://support.microsoft.com/kb/837932)
- [Solución de problemas al aparecer el error de replicación de AD 8451: la operación de replicación encontró un error de base de datos](http://support.microsoft.com/kb/2645996)
- [Solución de problemas al aparecer el error de replicación de AD 1127: al tener acceso al disco duro, se produjo un error en la operación de disco incluso tras varios intentos](http://support.microsoft.com/kb/2025726)
- [Limpiar los metadatos de servidor](https://technet.microsoft.com/en-us/library/cc816907.aspx)
...
|Poco óptimo    |Los datos no se escriben uniformemente entre las unidades. <br><br>**Acción**: optimice el uso de la unidad en el bloque de almacenamiento mediante la ejecución del cmdlet [Optimize-StoragePool](https://technet.microsoft.com/itpro/powershell/windows/storage/optimize-storagepool) .|
...
|Iniciando|La unidad se está preparando para la operación. Debe ser un estado temporal: una vez completada, la unidad debe pasar a un estado operativo diferente.|
...
|Medio extraíble|La unidad se clasifica como unidad extraíble. <br><br>Los espacios de almacenamiento no admiten los medios que Windows reconoce como extraíbles, como las unidades Blu-Ray. Aunque muchas unidades fijas están en ranuras extraíbles, en general, los medios que Windows *clasifica* como extraíbles no son adecuados para su uso con espacios de almacenamiento.|

...
| [System Center Virtual Machine Manager (SCVMM)](https://technet.microsoft.com/system-center-docs/vmm/manage/manage-storage-spaces-direct-vmm) <br>& [Operations Manager (SCOM)](https://www.microsoft.com/download/details.aspx?id=54700) | Gráfico    | Pagado     |

## <a name="get-started"></a>Introducción

Intente Espacios de almacenamiento directo [en Microsoft Azure](https://blogs.technet.microsoft.com/filecab/2016/05/05/s2dazuretp5/)o descargue una copia de evaluación con licencia de 180 días de Windows Server de las [evaluaciones de Windows Server](https://go.microsoft.com/fwlink/?linkid=842602).
...
- [Espacios de almacenamiento directo rendimiento con iWARP](https://blogs.technet.microsoft.com/filecab/2017/03/13/storage-spaces-direct-throughput-with-iwarp) (blog de TechNet)

...
**Caché de capa de bus de almacenamiento.** El bus de almacenamiento de software enlaza de forma dinámica las unidades más rápidas presentes (por ejemplo, SSD) con unidades más lentas (por ejemplo, HDD) para proporcionar almacenamiento en caché de lectura/escritura en el servidor que acelera la e/s y aumenta el rendimiento.

**Bloque de almacenamiento.** La colección de unidades que forman la base de Espacios de almacenamiento se denomina grupo de almacenamiento. Se crea automáticamente, y todas las unidades válidas se detectan y se agregan automáticamente. Te recomendamos encarecidamente que uses un grupo por cada clúster, con la configuración predeterminada. Lee nuestro blog sobre [profundización en el grupo de almacenamiento](https://blogs.technet.microsoft.com/filecab/2016/11/21/deep-dive-pool-in-spaces-direct/) para obtener más información.
...
- [Blog de Storage en Microsoft](https://blogs.technet.microsoft.com/filecab/)

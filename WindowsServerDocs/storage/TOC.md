...
### [Lista de comprobación: ajustar un espacio de nombres DFS](dfs-namespaces/checklist-tune-a-dfs-namespace.md)
...
## [Replicación de DFS](dfs-replication/dfsr-overview.md)
### [Migrar replicación de SYSVOL a replicación de DFS](dfs-replication/migrate-sysvol-to-dfsr.md)
### [Usar robocopy para preseleccionar archivos para replicación DFS](dfs-replication/preseed-dfsr-with-robocopy.md)
### [Replicación DFS: Preguntas frecuentes (FAQ)](dfs-replication/dfsr-faq.md)
...
### [Introducción al sistema de archivos de red](nfs/nfs-overview.md)
...
### [Lista de comprobación: aplicar un filtro de archivos a un volumen o carpeta](fsrm/checklist-apply-file-screen-to-volume-or-folder.md)
...
### [Implementar perfiles de usuario móvil](folder-redirection/deploy-roaming-user-profiles.md)
...
### [Secuencias de integridad](refs/integrity-streams.md)
...
### [Preguntas frecuentes (FAQ)](storage-migration-service/faq.md)
...
### [Réplica de almacenamiento: preguntas frecuentes](storage-replica/storage-replica-frequently-asked-questions.md)
...
#### [Supervisar con Azure Monitor](storage-spaces/configure-azure-monitor.md)
...
#### [Preguntas frecuentes](storage-spaces/storage-spaces-direct-faq.md)
## [Carpetas de trabajo](work-folders/work-folders-overview.md)
### [Diseño de una implementación de carpetas de trabajo](work-folders/plan-work-folders.md)
### [Implementar Carpetas de trabajo](work-folders/deploy-work-folders.md)
### [Implementación de carpetas de trabajo con AD FS y proxy de aplicación web (WAP)](work-folders/deploy-work-folders-adfs-overview.md)
#### [Paso1: Configurar AD FS](work-folders/deploy-work-folders-adfs-step1.md)
#### [Paso2: Tareas postconfiguración de AD FS](work-folders/deploy-work-folders-adfs-step2.md)
#### [Paso3: Configurar Carpetas de trabajo](work-folders/deploy-work-folders-adfs-step3.md)
#### [Paso4: Configurar WAP](work-folders/deploy-work-folders-adfs-step4.md)
#### [Paso5: Configurar los clientes](work-folders/deploy-work-folders-adfs-step5.md)

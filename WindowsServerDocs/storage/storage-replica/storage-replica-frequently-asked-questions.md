...
Notas adicionales en clústeres invitados en Azure se pueden encontrar en: [Implementación de clústeres de invitados de máquina virtual de IaaS en Microsoft Azure](https://blogs.msdn.microsoft.com/clustering/2017/02/14/deploying-an-iaas-vm-guest-clusters-in-microsoft-azure/).
...
2. Hay plantillas de Azure Resource Manager para clústeres de réplica de almacenamiento basado en espacios de almacenamiento directo en [crear un clúster de SOFS de espacios de almacenamiento directo (S2D) con la réplica de almacenamiento para la recuperación ante desastres entre regiones de Azure](https://aka.ms/azure-storage-replica-cluster).  

...
| Usage Type (Tipo de uso) | Cargas de trabajo ideales | Diferencias |
|------------|-----------------|------------------|
...
## <a name="data-deduplication-terminology"></a><a id="dedup-term"></a>Terminología de desduplicación de datos
| Término | Definición |
|------|------------|

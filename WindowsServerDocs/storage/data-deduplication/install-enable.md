...
1. En el Asistente para agregar roles y características, selecciona **Roles de servidor** y luego selecciona **Desduplicación de datos**.  
![Instalar Desduplicación de datos mediante el Administrador del servidor: seleccione Desduplicación de datos en Roles de servidor](media/install-dedup-via-server-manager-1.png)
...
### <a id="install-dedup-via-powershell"></a>Instalar Desduplicación de datos con PowerShell
...
## <a id="enable-dedup"></a>Habilitación de Desduplicación de datos
### <a id="enable-dedup-candidate-workloads"></a>Determinación de qué cargas de trabajo son candidatas para Desduplicación de datos
...
### <a id="enable-dedup-evaluating-sometimes-workloads"></a>Evaluar las cargas de trabajo para Desduplicación de datos
> [!Important]  
...
2. **¿Qué aspecto tienen mis patrones de E/S de la carga de trabajo con relación a su conjunto de datos? ¿Qué rendimiento obtengo para mi carga de trabajo?**  
...
### <a id="enable-dedup-lights-on"></a>Habilitación de Desduplicación de datos
...
#### <a id="enable-dedup-via-server-manager"></a>Habilitar Desduplicación de datos mediante el Administrador del servidor
...
#### <a id="enable-dedup-via-powershell"></a>Habilitar Desduplicación de datos con PowerShell

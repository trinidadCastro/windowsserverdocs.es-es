...
## <a id="install-dedup"></a>Instalar desduplicación de datos
> [!Important]  
...
### <a id="install-dedup-via-server-manager"></a>Instalar desduplicación de datos mediante el administrador del servidor
...
![Instalar desduplicación de datos mediante el administrador del servidor: seleccione desduplicación de datos de Roles de servidor](media/install-dedup-via-server-manager-1.png)
2. Haga clic en **Siguiente** hasta que se active el botón **Instalar** y, a continuación, haga clic en **Instalar**.  
![Instalar desduplicación de datos mediante el administrador del servidor: haga clic en instalar](media/install-dedup-via-server-manager-2.png)

### <a id="install-dedup-via-powershell"></a>Instalar desduplicación de datos mediante PowerShell
...
### <a id="enable-dedup-candidate-workloads"></a>Determine qué cargas de trabajo son candidatos para desduplicación de datos
...
### <a id="enable-dedup-evaluating-sometimes-workloads"></a>Evalúe las cargas de trabajo para desduplicación de datos
> [!Important]  
...
1. **¿El conjunto de datos de mi carga de trabajo tiene suficiente duplicación para beneficiarse de la habilitación de desduplicación?**  
...
2. **¿Qué patrones de E/S de la carga de trabajo en su conjunto de datos se parecen a? ¿Qué rendimiento es necesario para la carga de trabajo?**  
...
3. **¿Cuáles son los requisitos de recursos de la carga de trabajo en el servidor?**  
...
#### <a id="enable-dedup-via-server-manager"></a>Habilitar la desduplicación de datos mediante el administrador del servidor
...
![Haga clic en los volúmenes](media/enable-dedup-via-server-manager-2.png)
...
![Seleccione el tipo de uso deseado en la lista desplegable](media/enable-dedup-via-server-manager-4.png)
...
#### <a id="enable-dedup-via-powershell"></a>Habilitar desduplicación de datos mediante PowerShell
...
**¿Cuáles son los requisitos de tamaño de volumen para los volúmenes desduplicados?**  
...
**¿Es necesario modificar la programación u otros valores de desduplicación de datos para cargas de trabajo recomendadas?**  

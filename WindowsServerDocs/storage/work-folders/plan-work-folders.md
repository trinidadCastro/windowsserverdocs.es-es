...
- Conocimientos básicos sobre cómo habilitar el acceso web a recursos internos a través de un proxy inverso web  
  ...
  Las siguientes secciones te servirán para diseñar la implementación de Carpetas de trabajo. La implementación de Carpetas de trabajo se detalla en el siguiente tema, [Deploying Work Folders](deploy-work-folders.md).  
...
|------------------|----------------|  
|**Evaluación del producto**|[carpetas de trabajo](work-folders-overview.md) de -   <br />-   [carpetas de trabajo para Windows 7](https://blogs.technet.com/b/filecab/archive/2014/04/24/work-folders-for-windows-7.aspx) (entrada de blog)|  
|**Implementación**|-   [diseñar una implementación de carpetas de trabajo](plan-work-folders.md)<br />-   [implementar carpetas de trabajo](deploy-work-folders.md)<br />-   [implementar carpetas de trabajo con AD FS y proxy de aplicación web (WAP)](deploy-work-folders-adfs-overview.md)<br />- [implementar carpetas de trabajo con Azure ad proxy de aplicación](https://blogs.technet.microsoft.com/filecab/2017/05/31/enable-remote-access-to-work-folders-using-azure-active-directory-application-proxy/)<br />-   [consideraciones de rendimiento de las implementaciones de carpetas de trabajo](https://blogs.technet.com/b/filecab/archive/2013/11/01/performance-considerations-for-large-scale-work-folders-deployments.aspx)<br />-   [carpetas de trabajo para Windows 7 (descarga de 64 bits)](https://www.microsoft.com/download/details.aspx?id=42558)<br />-   [carpetas de trabajo para Windows 7 (descarga de 32 bits)](https://www.microsoft.com/download/details.aspx?id=42559)<br />-   de la [implementación del laboratorio de pruebas de carpetas de trabajo](https://blogs.technet.com/b/filecab/archive/2013/07/10/work-folders-test-lab-deployment.aspx) (entrada de blog)|

...
| ------------------- | ------------------ | ----------------- |  
| Servicio de rol de Carpetas de trabajo en el Administrador del servidor | Windows Server 2012 R2, Windows Server 2016 o Windows Server de 2019 | Los Servicios de almacenamiento y archivos son una buena manera de configurar los recursos compartidos de sincronización (es decir, carpetas que almacenan los archivos de trabajo del usuario), supervisar Carpetas de trabajo y administrar los recursos compartidos de sincronización y el acceso de los usuarios |
| Cmdlets de Carpetas de trabajo | Windows Server 2012 R2, Windows Server 2016 o Windows Server de 2019 | Módulo de Windows PowerShell que contiene cmdlets completos para administrar los servidores de Carpetas de trabajo |  
...
-   Un servidor que ejecuta Windows Server 2019, Windows Server 2016 o Windows Server 2012 R2 para hospedar la sincronización se comparte con los archivos de usuario  
...
-   (Opcional) Un bosque de Active Directory Domain Services con las extensiones de esquema en Windows Server 2012 R2 para admitir remitir automáticamente los equipos y dispositivos al servidor de archivos correcta al usar varios servidores de archivos.  

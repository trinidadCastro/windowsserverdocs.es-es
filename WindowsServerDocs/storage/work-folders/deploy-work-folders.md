...
4.  En la página **Seleccionar roles de servidor**, expande **Servicios de archivos y almacenamiento**, expande **Servicios de iSCSI y archivo**y posteriormente selecciona **Carpetas de trabajo**.  
...
3.  Haz clic con el botón derecho en el contenedor en el cual quieres crear el grupo (por ejemplo, el contenedor Usuarios de la unidad organizativa o el dominio adecuados), haz clic en **Nuevo** y, a continuación, haz clic en **Grupo**.

4.  En la ventana **Crear grupo** de la sección **Grupo**, especifica la configuración siguiente:

    -   En **Nombre de grupo**, escribe el nombre del grupo de seguridad; por ejemplo, **Usuarios del recurso compartido de sincronización de RRHH** o **Administradores de Carpetas de trabajo**.  
  
    -   En **Ámbito de grupo**, haz clic en **Seguridad** y posteriormente haz clic en **Global**.  
  
5.  En la sección **Miembros**, haz clic en **Agregar**. Aparecerá el cuadro de diálogo Seleccionar usuarios, contactos, equipos, cuentas de servicio o grupos.  
...
2.  En el menú **Herramientas**, haz clic en **Usuarios y equipos de Active Directory**. Aparecerá la opción Usuarios y equipos de Active Directory.  
...
6.  En la página **Tipo de objeto de Active Directory**, haz clic en **Solo los siguientes objetos de la carpeta** y activa la casilla **Objetos de usuario**.  
  
7.  En la página **Permisos**, desactiva la casilla **General**, activa la casilla **Específico de la propiedad** y, a continuación, activa las casillas **Lectura de msDS-SyncServerUrl** y **Escritura de msDS-SyncServerUrl**.
...
8.  En la página **Especificar directivas de dispositivos**, especifica si se solicitarán restricciones de seguridad en los dispositivos y equipos cliente. Hay dos directivas de dispositivos que pueden seleccionarse de forma individual:  
    ...
    -   **Bloquear pantalla automáticamente y requerir contraseña** Solicita que los dispositivos y equipos cliente bloqueen automáticamente sus pantallas transcurridos 15 minutos, requieran una contraseña de seis o más caracteres para desbloquear la pantalla y activen un modo de bloqueo del dispositivo tras 10 intentos fallidos.  
        ...
        > [!IMPORTANT]
        >  Para aplicar obligatoriamente directivas de contraseña en equipos con Windows 7 y para aquellos que no sean administradores de equipos unidos a dominios, usa las directivas de contraseña de directiva de grupo de los dominios de equipo y excluye estos dominios de las directivas de contraseña de Carpetas de trabajo. Puedes excluir dominios mediante el cmdlet [Set-Syncshare -PasswordAutoExcludeDomain](http://technet.microsoft.com/library/dn296649\(v=wps.630\).aspx) después de crear el recurso compartido de sincronización. Para obtener información sobre la configuración de directivas de contraseña de la directiva de grupo, consulta [Directiva de contraseña](https://technet.microsoft.com/library/hh994572(v=ws.11).aspx).  
...
1.  En el Administrador del servidor, haz clic en **Servicios de archivos y almacenamiento** y en **Servidores**.  
...
6.  En el cuadro **Valor para agregar**, escribe la URL del servidor de sincronización con el cual quieres sincronizar el usuario, haz clic en **Agregar**, en **Aceptar** y, de nuevo, en **Aceptar**.  
  
    > [!NOTE]
    >  La URL del servidor de sincronización es simplemente `https://` o `http://` (en función de si quieres requerir una conexión segura) seguido del nombre de dominio completo del servidor de sincronización. Por ejemplo, **https://sincro1.contoso.com**.
...
-   Aplica la configuración automática de Carpetas de trabajo mediante la configuración predeterminada (revisa los aspectos tratados acerca de la directiva de grupo en [Diseñar una implementación de Carpetas de trabajo](plan-work-folders.md) antes de hacerlo)  
...
|------------------|----------------|  
|**Amplia tus conocimientos**|-   [Carpetas de trabajo](work-folders-overview.md)|  
|**Planificación**|-   [Diseñar una implementación de carpetas de trabajo](plan-work-folders.md)|
|**Implementación**|-   [Implementar carpetas de trabajo con AD FS y proxy de aplicación web (WAP)](deploy-work-folders-adfs-overview.md)<br />-   [Implementación de prueba de Carpetas de trabajo](http://blogs.technet.com/b/filecab/archive/2013/07/10/work-folders-test-lab-deployment.aspx) (entrada de blog)<br />-   [Un nuevo atributo de usuario para la URL del servidor de Carpetas de trabajo](http://blogs.technet.com/b/filecab/archive/2013/10/09/a-new-user-attribute-for-work-folders-server-url.aspx) (entrada de blog)|  
|**Referencia técnica**|-   [Inicio de sesión interactivo: umbral de bloqueo de cuenta del equipo](https://technet.microsoft.com/library/jj966264(v=ws.11).aspx)<br />-   [Cmdlets de recurso compartido de sincronización](https://technet.microsoft.com/itpro/powershell/windows/sync-share)|

...
| Compatibilidad nativa con llamadas a la API de FileNormalizedNameInformation | New | Agrega compatibilidad nativa para consultar el nombre normalizado de un archivo. Para obtener más información, consulta [FileNormalizedNameInformation](/openspecs/windows_protocols/ms-fscc/20bcadba-808c-4880-b757-4af93e41edf6). |

Para obtener detalles adicionales, consulta la entrada de blog [Novedades en SMB 3.1.1 en la versión preliminar técnica 2 de Windows Server 2016](/archive/blogs/josebda/whats-new-in-smb-3-1-1-in-the-windows-server-2016-technical-preview-2).
